...
import vrimplantacao.dao.interfaces.PlanilhaFornecedorDAO;
import vrimplantacao.vo.loja.LojaVO;

public class PlanilhaFornecedorGUI extends VRInternalFrame {

    public PlanilhaFornecedorGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    if (rdbRabelo.isSelected()) {
                        new PlanilhaFornecedorDAO().importarFornecedorRabelo(flcArquivoProduto.getArquivo(), cmbLojaDestino.getId());
                    }
                    
                    if (rdbProdutoFornecedor.isSelected()) {
                        new PlanilhaFornecedorDAO().importarProdutoFornecedor(flcArquivoProduto.getArquivo());
                    }
    ...
    private void initComponents() {
        ...
        rbgGrupo1 = new vrframework.bean.buttonGroup.VRButtonGroup();
        vRPanel1 = new vrframework.bean.panel.VRPanel();
        vRLabel1 = new vrframework.bean.label.VRLabel();
        flcArquivoProduto = new vrframework.bean.fileChooser.VRFileChooser();
        rdbRabelo = new vrframework.bean.radioButton.VRRadioButton();
        ...
        setResizable(true);
        setTitle("Migração Planilha Fornecedores");
        setToolTipText("");

        vRPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Dados Origem"));
        vRPanel1.setPreferredSize(new java.awt.Dimension(350, 350));

        vRLabel1.setText("Planilha Fornecedores");

        flcArquivoProduto.setObrigatorio(true);

        rbgGrupo1.add(rdbRabelo);
        rdbRabelo.setText("Fornecedores - Rabelo");
        rdbRabelo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rdbRabeloActionPerformed(evt);
            }
        });

        rdbProdutoFornecedor.setText("Produto Fornecedor");
                ...
                .addGroup(vRPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(vRPanel1Layout.createSequentialGroup()
                        .addGroup(vRPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(rdbRabelo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(vRPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 146, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void rdbRabeloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rdbRabeloActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_rdbRabeloActionPerformed
    ...
    private vrframework.bean.buttonGroup.VRButtonGroup rbgGrupo1;
    private vrframework.bean.radioButton.VRRadioButton rdbProdutoFornecedor;
    private vrframework.bean.radioButton.VRRadioButton rdbRabelo;
