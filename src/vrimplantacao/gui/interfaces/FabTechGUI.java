...
public class FabTechGUI extends VRInternalFrame {

    private static final String SISTEMA = "FabTech";
    private static final String SERVIDOR_SQL = "Sql Server";
    private static FabTechGUI instance;
    private String vLojaCliente = "-1";
    private int vLojaVR = 1;    
    private final FabTechDAO fabTechDAO = new FabTechDAO();
    ...
    public FabTechGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    Importador importador = new Importador(fabTechDAO);
                    ...
                    ProgressBar.dispose();
                    Util.exibirMensagem("Importação Fabtech realizada com sucesso!", getTitle());
    ...
    private void initComponents() {
        ...
        chkPrecoProduto.setText("Preco Produto");
        ...
        vRPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(vRPanel2Layout.createSequentialGroup()
                ...
                .addGap(42, 42, 42)
                .addGroup(vRPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(chkEstoqueProduto, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(vRPanel2Layout.createSequentialGroup()
                        .addGroup(vRPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        vRPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("Fornecedor"));
        ...
        vRPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder("Cliente"));
        ...
        tabs.addTab("Importação", vRPanel6);
        ...
        tabs.addTab("Unificação", vRPanel7);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(vRPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 599, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
