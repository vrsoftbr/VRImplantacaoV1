...
import vrimplantacao.dao.interfaces.BoechatSoftDAO;
import vrimplantacao.vo.loja.LojaVO;

public class BoechatSoftGUI extends VRInternalFrame {

    private BoechatSoftDAO importacaoBoechatSoftDAO = new BoechatSoftDAO();
    ...
    public BoechatSoftGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        
        txtHostSqlServer.setText("127.0.0.1");
        txtBancoDadosSqlServer.setText("BoechatSoft_BailoCentral");
            ...
            public void run() {
                ...
                try {
                    ...
                    if ((!txtArquivoBalanca.getArquivo().isEmpty()) &&
                        ...
                        importacaoBoechatSoftDAO.importarProdutoBalanca(txtArquivoBalanca.getArquivo(), opcao);
                    }
                    
                    
                    ProgressBar.dispose();

                    Util.exibirMensagem("Importação BoachatSoft realizada com sucesso!", getTitle());
            ...
            public void run() {
                try {
                    ...
                    if (chkFamiliaProduto.isSelected()) {                        
                        importacaoBoechatSoftDAO.importarFamiliaProduto();
                    }
                    
                    if (chkMercadologico.isSelected()) {
                        importacaoBoechatSoftDAO.importarMercadologico();
                    }
                    
                    if (chkProduto.isSelected()) {
                        importacaoBoechatSoftDAO.importarProduto(id_loja);
                    }
                    
                    if (chkCustoProduto.isSelected()) {
                        importacaoBoechatSoftDAO.importarCustoProduto(id_lojaCliente, id_loja);
                    }                    
                    
                    if (chkPrecoProduto.isSelected()) {
                        importacaoBoechatSoftDAO.importarPrecoProduto(id_lojaCliente, id_loja);
                    }                                        
                    
                    if (chkEstoqueProduto.isSelected()) {
                        importacaoBoechatSoftDAO.importarEstoqueProduto(id_lojaCliente, id_loja);
                    }                      
                    
                    if (chkIcms.isSelected()) {
                        importacaoBoechatSoftDAO.importarIcmsProduto();
                    }
                    
                    if (chkDataCadastro.isSelected()) {
                        importacaoBoechatSoftDAO.importarDataProduto();
                    }
                    
                    if (chkProdSemCodBarra.isSelected()) {
                        importacaoBoechatSoftDAO.importarCodigoBarraEmBranco();
                    }
                    
                    if (chkFornecedor.isSelected()) {
                        importacaoBoechatSoftDAO.importarFornecedor();
                    } 
                    ...
                    if (chkClientePreferencial.isSelected()) {
                        importacaoBoechatSoftDAO.importarClientePreferencial(id_lojaCliente, id_loja);
                    }
                    
                    if (chkCreditoRotativo.isSelected()) {
                        importacaoBoechatSoftDAO.importarReceberCliente(id_lojaCliente, id_loja);
                    }                    
                    ...
                    if (chkValorLimiteCliente.isSelected()) {
                        importacaoBoechatSoftDAO.importarValorLimiteCliente();
                    }
                    
                    if (chkNumEnderecoCliente.isSelected()) {
                        importacaoBoechatSoftDAO.importarNumeroEnderecoCliente();
                    }
                    
                    ProgressBar.dispose();
                    Util.exibirMensagem("Importação BoeachatSoft realizada com sucesso!", getTitle());
                } catch (Exception ex) {
                    try {                    
                        connSQLServer.close();
                    } catch (Exception ex1) {
    ...
    private void initComponents() {
        ...
        chkPisCofins1 = new vrframework.bean.checkBox.VRCheckBox();
        chkIcms = new vrframework.bean.checkBox.VRCheckBox();
        chkValorLimiteCliente = new vrframework.bean.checkBox.VRCheckBox();
        chkNumEnderecoCliente = new vrframework.bean.checkBox.VRCheckBox();
        chkDataCadastro = new vrframework.bean.checkBox.VRCheckBox();
        chkProdSemCodBarra = new vrframework.bean.checkBox.VRCheckBox();
        ...
        setTitle("Importação BoechatSoft");
        setToolTipText("");
        ...
        chkPisCofins1.setText("PisCofins");

        chkIcms.setText("Icms");

        chkValorLimiteCliente.setText("Atualizar Limite (Cliente)");

        chkNumEnderecoCliente.setText("Atualizar Num. End (Cliente)");

        chkDataCadastro.setText("Data Cadastro");

        chkProdSemCodBarra.setText("Produto sem Codigo Barra");
        ...
        vRPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(vRPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(vRPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(chkPisCofins1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addComponent(chkProdSemCodBarra, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(vRPanel2Layout.createSequentialGroup()
                        .addGroup(vRPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(vRPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(chkValorLimiteCliente, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(chkNumEnderecoCliente, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        vRPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(vRPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtArquivoBalanca, javax.swing.GroupLayout.DEFAULT_SIZE, 331, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(vRPanel1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 659, Short.MAX_VALUE)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(vRPanel2, javax.swing.GroupLayout.DEFAULT_SIZE, 659, Short.MAX_VALUE))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(vRPanel2, javax.swing.GroupLayout.PREFERRED_SIZE, 245, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private vrframework.bean.checkBox.VRCheckBox chkNumEnderecoCliente;
    private vrframework.bean.checkBox.VRCheckBox chkPisCofins1;
    private vrframework.bean.checkBox.VRCheckBox chkPrecoProduto;
    private vrframework.bean.checkBox.VRCheckBox chkProdSemCodBarra;
    private vrframework.bean.checkBox.VRCheckBox chkProduto;
    private vrframework.bean.checkBox.VRCheckBox chkProdutoFornecedor;
    private vrframework.bean.checkBox.VRCheckBox chkValorLimiteCliente;
