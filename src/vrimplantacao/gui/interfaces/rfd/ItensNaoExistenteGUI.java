...
public class ItensNaoExistenteGUI extends VRInternalFrame {
    
    private static ItensNaoExistenteGUI instance;
    private ItensNaoExistentesController controller;    

    public ItensNaoExistenteGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        vColunaMapa.add(new VRColumnTable("Cód. RFD", true, SwingConstants.LEFT, false, null));
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new ItensNaoExistenteGUI(i_mdiFrame);
