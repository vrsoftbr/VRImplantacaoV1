...
public class WisaSoftGUI_2 extends VRInternalFrame {

    private static final String SISTEMA = "WisaSoft";
    private static final String SERVIDOR_SQL = "Firebird";
    private static WisaSoftGUI_2 instance;

    private String vLojaCliente = "-1";
    private int vLojaVR = -1;

    private WisaSoftDAO wisaSoftDAO = new WisaSoftDAO();
    ...
    public WisaSoftGUI_2(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    /*public void carregarLojaCliente() throws Exception {
     ...
     int cont = 0;
     int index = 0;
     for (Estabelecimento loja: delfiDAO.getLojasCliente()) {
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    Importador importador = new Importador(wisaSoftDAO);
                    ...
                    if (tabs.getSelectedIndex() == 0) {
                        ...
                        if (chkProdutosSemBarras.isSelected()) {
                    ...
                    ProgressBar.dispose();
                    Util.exibirMensagem("Importação Delfi realizada com sucesso!", getTitle());
                } catch (Exception ex) {
                    try {
                        connFirebird.close();
                    } catch (Exception ex1) {
    ...
    private void initComponents() {
        ...
        chkProdutosSemBarras = new vrframework.bean.checkBox.VRCheckBox();
        ...
        chkProdutosSemBarras.setText("Produtos Sem Codigo Barras");

        chkCodigoBarras.setText("Código de Barras");
            ...
            .addGroup(vRPanel5Layout.createSequentialGroup()
                ...
                .addGroup(vRPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(vRPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addComponent(chkPreco, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                .addGroup(vRPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(chkProdutosSemBarras, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        chkCreditoRotativo.setText("Receber Credito Rotativo");

        chkCheque.setText("Receber Cheque");
    ...
    private vrframework.bean.checkBox.VRCheckBox chkProdutosSemBarras;
