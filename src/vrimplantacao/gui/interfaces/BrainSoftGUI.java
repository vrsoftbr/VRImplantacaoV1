...
public class BrainSoftGUI extends VRInternalFrame {
    ...
    private static final String SISTEMA = "Paradox";
    private ConexaoParadox connParadox = new ConexaoParadox();
    public BrainSoftDAO importarBrainSoft = new BrainSoftDAO();
            ...
            public void run() {
                try {
                    if (!validarDadosAcessoParadox()) {
                        ...
                        Importador importador = new Importador(importarBrainSoft);
