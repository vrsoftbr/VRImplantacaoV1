...
import vrimplantacao.dao.interfaces.AlterarProdutoPdvVendaItemDAO;
import vrimplantacao.utils.Utils;
import vrimplantacao.vo.loja.LojaVO;

public class AlterarProdutoPdvVendaItemGUI extends VRInternalFrame {

    AlterarProdutoPdvVendaItemDAO dao = new AlterarProdutoPdvVendaItemDAO();

    public AlterarProdutoPdvVendaItemGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        carregarLojaDestino();
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    if ((txtDtInicio.getText().matches("[0-9]{2}\\/[0-9]{2}\\/[0-9]{4}"))
                            || (txtDtFim.getText().matches("[0-9]{2}\\/[0-9]{2}\\/[0-9]{4}"))) {

                        dao.dataInicio = Utils.convertStringToDate("dd/MM/yyyy", txtDtInicio.getText());
                        dao.dataFim = Utils.convertStringToDate("dd/MM/yyyy", txtDtFim.getText());
                        dao.idLoja = cmbLojaDestino.getId();
                        dao.importarAlterarProdutoPdvVendaItem();
                        Util.exibirMensagem("Alteração pdv.vendaitem realizada com sucesso!!!", getTitle());
                    } else {
                        Util.exibirMensagem("Preencha os campos necessário para importação!!!", getTitle());
                    }
                    ProgressBar.dispose();
                } catch (Exception ex) {
                    ProgressBar.dispose();
    ...
    private void initComponents() {
        ...
        txtDtInicio = new vrframework.bean.textField.VRTextField();
        txtDtFim = new vrframework.bean.textField.VRTextField();
        ...
        setResizable(true);
        setTitle("Alteração Produto Pdv.VendaItem");
        setToolTipText("");
        ...
        vRLabel1.setText("Data Fim:");

        txtDtInicio.setEnabled(true);
        txtDtInicio.setMascara("Data");

        txtDtFim.setEnabled(true);
        txtDtFim.setMascara("Data");
            ...
            .addGroup(vRPanel1Layout.createSequentialGroup()
                .addGroup(vRPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(vRPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(txtDtInicio, javax.swing.GroupLayout.PREFERRED_SIZE, 78, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(31, 31, 31)
                        .addComponent(vRLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtDtFim, javax.swing.GroupLayout.PREFERRED_SIZE, 78, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(vRPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, 67, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private vrframework.bean.textField.VRTextField txtDtFim;
    private vrframework.bean.textField.VRTextField txtDtInicio;
