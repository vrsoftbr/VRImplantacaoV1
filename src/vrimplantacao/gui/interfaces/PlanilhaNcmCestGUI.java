...
public class PlanilhaNcmCestGUI extends VRInternalFrame {

    public PlanilhaNcmCestGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
