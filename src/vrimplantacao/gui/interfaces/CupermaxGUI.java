...
public class CupermaxGUI extends VRInternalFrame {
    
    private static final String SISTEMA = "Cupermax";
    private static final String SERVIDOR_SQL = "Oracle";
    private static CupermaxGUI instance;
    ...
    private void carregarParametros() throws Exception {
        ...
        txtHost.setText(params.getWithNull(CupermaxDAO.HOST, SISTEMA, "HOST"));
        txtDatabase.setText(params.getWithNull(CupermaxDAO.DATABASE, SISTEMA, "DATABASE"));
        txtPorta.setText(params.getWithNull(CupermaxDAO.PORT, SISTEMA, "PORTA"));
        txtUsuario.setText(params.getWithNull(CupermaxDAO.USER, SISTEMA, "USUARIO"));
        txtSenha.setText(params.getWithNull(CupermaxDAO.PASSWORD, SISTEMA, "SENHA"));
    ...
    private CupermaxDAO cupermaxDAO = new CupermaxDAO();
    private ConexaoOracle connOracle = new ConexaoOracle();

    
    private CupermaxGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public void carregarLojaCliente() throws Exception {
        ...
        int cont = 0;
        int index = 0;
        for (Estabelecimento loja: cupermaxDAO.getLojasCliente()) {
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new CupermaxGUI(i_mdiFrame);
            }
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    cupermaxDAO.v_codEmpresaConv = txtCodEmpresaConv.getText().trim();
                    
                    Importador importador = new Importador(cupermaxDAO);
    ...
    private void initComponents() {
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtStrConexao, javax.swing.GroupLayout.DEFAULT_SIZE, 408, Short.MAX_VALUE)
                .addContainerGap())
        );
