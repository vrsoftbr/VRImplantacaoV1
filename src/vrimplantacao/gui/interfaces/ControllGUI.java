...
import vrimplantacao.dao.interfaces.ControllDAO;
...
public class ControllGUI extends VRInternalFrame {    
    
    private static final String NOME_SISTEMA = "Controll";
    private static final String SERVIDOR_SQL = "Firebird";
    private static ControllGUI instance;
    
    private final ControllDAO controllDAO = new ControllDAO();   
    ...
    public static final String SISTEMA = "CONTROLL";
    ...
    private ControllGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public void carregarLojaCliente() throws Exception {
        ...
        int cont = 0;
        int index = 0;
        for (ItemComboVO loja: controllDAO.getLojasCliente()) {
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    Importador importador = new Importador(controllDAO.getProdutoDao());
                    ...
                    if (tab.getSelectedIndex() == 0) {
                        ...
                        if (chkClientePreferencial.isSelected()) {
                            controllDAO.importarClientePreferencial(idLojaVR, idLojaCliente);
                        }
                        ...
                        if (chkUnifClientePreferencial.isSelected()) {
                            controllDAO.integrarClienteCpfCnpj(idLojaVR, idLojaCliente);
                        }
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new ControllGUI(i_mdiFrame);
            }
    ...
    private void initComponents() {
        ...
        vRPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("Cliente"));
