...
import vrimplantacao.dao.interfaces.OrionDAO;
import vrimplantacao.vo.loja.LojaVO;
import vrimplantacao.vo.vrimplantacao.EstadoVO;
import vrimplantacao2.parametro.Parametros;

public class OrionGUI extends VRInternalFrame {

    private ConexaoDBF connDBF = new ConexaoDBF();
    public OrionDAO importarOrion = new OrionDAO();
    
    public OrionGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
            ...
            public void run() {
                try {
                    ...
                    if (chkFamiliaProduto.isSelected()) {
                        new OrionDAO().importarFamiliaProduto(txtPath.getText());
                    }
                    
                    if (chkMercadologico.isSelected()) {                        
                        new OrionDAO().importarMercadologico(txtPath.getText());
                    }
                    
                    if (chkProdutos.isSelected()) {                        
                        if (!chkManterBalanca.isSelected()) {
                            new OrionDAO().importarProduto(txtPath.getText(), cmbLojaDestino.getId());
                        } else {
                            new OrionDAO().importarProdutoManterBalanca(txtPath.getText(), cmbLojaDestino.getId());
                        }
                    }
                    
                    if (chkCusto.isSelected()) {
                        new OrionDAO().importarCusto(txtPath.getText(), cmbLojaDestino.getId());
                    }
                    
                    if (chkPreco.isSelected()) {
                        new OrionDAO().importarPrecoVenda(txtPath.getText(), cmbLojaDestino.getId());
                    }
                    
                    if (chkEstoque.isSelected()) {
                        new OrionDAO().importarEstoque(txtPath.getText(), cmbLojaDestino.getId());
                    }

                    if (chkCodigoBarra.isSelected()) {
                        new OrionDAO().importarCodigoBarra(txtPath.getText(), cmbLojaDestino.getId());
                    }
                    
                    if (chkProdutoSemBarra.isSelected()) {
                        new OrionDAO().importarCodigoBarraEmBranco();
                    }
                    
                    if (chkDataCadastro.isSelected()) {
                        new OrionDAO().importarDataCadastroProduto(txtPath.getText());
                    }
                    
                    if (chkFornecedor.isSelected()) {
                        new OrionDAO().importarFornecedor(txtPath.getText());
                    }
                    
                    if (chkProdutoFornecedor.isSelected()) {
                        new OrionDAO().importarProdutoFornecedor(txtPath.getText());                        
                    }

                    if (chkClienteEventual.isSelected()) {
                        new OrionDAO().importarClienteEventual(txtPath.getText());
                    }

                    if (chkClientePreferencial.isSelected()) {
                        new OrionDAO().importarClientePreferencial(txtPath.getText());
                    }
                    
                    if (chkReceberCreditoRotativo.isSelected()) {
                        new OrionDAO().importarReceberCreditoRotativo(txtPath.getText(), cmbLojaDestino.getId());
                    }
                    
                    if (chkReceberCreditoRotativoBaixados.isSelected()) {
                        new OrionDAO().importarReceberCreditoRotativoBaixado(txtPath.getText(), cmbLojaDestino.getId());
                    }
                    
                    /* especiais */
                    if (chkAcertarFamiliaProduto.isSelected()) {
                        new OrionDAO().importarAcertarFamiliaProduto(txtPath.getText());
                    }
                    
                    if (chkAcertarMercadologicoProduto.isSelected()) {
                        new OrionDAO().importarAcertarMercadologicoProduto(txtPath.getText());
                    }
                    
                    if (chkAcertarPisCofins.isSelected()) {
                        new OrionDAO().importarAcertarPisCofinsProduto(txtPath.getText());
                    }
                    
                    if (chkAcertarNcmProduto.isSelected()) {
                        new OrionDAO().importarAcertarNcmProduto(txtPath.getText(), cmbLojaDestino.getId());
                    }
                    
                    ProgressBar.dispose();

                    Util.exibirMensagem("Importação Orion realizada com sucesso!", getTitle());
            ...
            public void run() {
                ...
                try {
                    ...
                    if ((!txtArquivoBalanca.getArquivo().isEmpty()) &&
                        ...
                        importarOrion.importarProdutoBalanca(txtArquivoBalanca.getArquivo(), opcao);
                    }
    ...
    private void initComponents() {
        ...
        chkAcertarNcmProduto = new vrframework.bean.checkBox.VRCheckBox();
        ...
        chkProdutoSemBarra.setText("Produtos S/Barras");
        ...
        vRPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(vRPanel6Layout.createSequentialGroup()
                ...
                .addGroup(vRPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(chkProdutoSemBarra, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        vRPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder("Cliente Preferencial")));
        ...
        chkReceberCreditoRotativoBaixados.setText("Receber Crédito Rotativo Baixado");
        ...
        chkAcertarFamiliaProduto.setText("Acertar Familia Produto");

        chkAcertarMercadologicoProduto.setText("Acertar Mercadologico Produto");

        chkAcertarPisCofins.setText("Acertar PisCofins Produto");

        chkAcertarNcmProduto.setText("Acertar Ncm Produto");
        ...
        vRPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(vRPanel8Layout.createSequentialGroup()
                ...
                .addGroup(vRPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(chkAcertarNcmProduto, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(vRPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 694, Short.MAX_VALUE)
    ...
    private vrframework.bean.checkBox.VRCheckBox chkAcertarNcmProduto;
