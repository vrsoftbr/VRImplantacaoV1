...
import vrimplantacao.dao.interfaces.GuiaSistemasDAO;
import vrimplantacao.vo.loja.LojaVO;

public class GuiaSistemasGUI extends VRInternalFrame {

    private GuiaSistemasDAO importacaoGuiaSistemasServerDAO = new GuiaSistemasDAO();
    ...
    public GuiaSistemasGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        
        txtHostSqlServer.setText("192.168.0.98");
        txtBancoDadosSqlServer.setText("GR");
        txtUsuarioSqlServer.setText("sa");
        txtSenhaSqlServer.setText("vrimplantacao");
        txtPortaSqlServer.setText("1433");  
        
        txtLojaCliente.setText("19");          
            ...
            public void run() {
                ...
                try {
                    ...
                    if ((!txtArquivoBalanca.getArquivo().isEmpty()) &&
                        ...
                        importacaoGuiaSistemasServerDAO.importarProdutoBalanca(txtArquivoBalanca.getArquivo(), opcao);
                    }
            ...
            public void run() {
                try {
                    ...
                    if (chkFamiliaProduto.isSelected()) {                        
                        importacaoGuiaSistemasServerDAO.importarFamiliaProduto();
                    }
                    
                    if (chkMercadologico.isSelected()) {
                        importacaoGuiaSistemasServerDAO.importarMercadologico();
                    }
                    
                    if (chkProduto.isSelected()) {
                        importacaoGuiaSistemasServerDAO.importarProduto(id_loja,id_lojaCliente);
                    }
                    
                    if (chkCustoProduto.isSelected()) {
                        importacaoGuiaSistemasServerDAO.importarCustoProduto(id_loja, id_lojaCliente);
                    }                    
                    
                    if (chkPrecoProduto.isSelected()) {
                        importacaoGuiaSistemasServerDAO.importarPrecoProduto(id_loja, id_lojaCliente);
                    }                                        
                    
                    if (chkEstoqueProduto.isSelected()) {
                        importacaoGuiaSistemasServerDAO.importarEstoqueProduto(id_loja, id_lojaCliente);
                    }                      
                    
                    if (chkFornecedor.isSelected()) {
                        importacaoGuiaSistemasServerDAO.importarFornecedor();
                    } 
                    
                    if (chkProdutoFornecedor.isSelected()) {
                        importacaoGuiaSistemasServerDAO.importarProdutoFornecedor();
                    }

                    if (chkClientePreferencial.isSelected()) {
                        importacaoGuiaSistemasServerDAO.importarClientePreferencial(id_loja, id_lojaCliente);
                    } 
                    
                    //if (chkCreditoRotativo.isSelected()) {
                        //importacaoGuiaSistemasServerDAO.importarReceberCliente(id_loja, id_lojaCliente);
                    //}                    
                    
                    if (chkChequeReceber.isSelected()) {
                        importacaoGuiaSistemasServerDAO.importarChequeReceber(id_loja, id_lojaCliente);
                    }
                    
                    //if (chkClienteDuplicado.isSelected()) {
                    //    importacaoGuiaSistemasServerDAO.corrigirClienteDuplicado();
                    //}
                    
                    if (chkCodigobarras.isSelected()) {
                        importacaoGuiaSistemasServerDAO.importarCodigoBarra();
                    }
                    
                    //if (chkPisCofins1.isSelected()) {
                    //    importacaoGuiaSistemasServerDAO.importarPisCofinsProdutoGuiaSistemas();
                    //}
                    
                    //if (chkFamilia.isSelected()) {
                    //    importacaoGuiaSistemasServerDAO.importarProdutoFamiliaGuiaSistemas();
                    //}

                    //if (chkTipoEmbalagem.isSelected()) {
                    //    importacaoGuiaSistemasServerDAO.importarTipoEmbalagem();
                    //}
                    
                    ProgressBar.dispose();
                    Util.exibirMensagem("Importação Guia Sistemas realizada com sucesso!", getTitle());
                } catch (Exception ex) {
                    try {                    
                        connSQLServer.close();
                    } catch (Exception ex1) {
    ...
    private void initComponents() {
        ...
        setTitle("Importação Guia Sistemas (SQL Server)");
        setToolTipText("");
        ...
        vRLabel1.setText("Cod. Loja (Cliente):");
        ...
        vRPanel2Layout.setVerticalGroup(
            ...
            .addGroup(vRPanel2Layout.createSequentialGroup()
                ...
                .addComponent(chkEstoqueProduto, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(3, 3, 3)
                .addComponent(chkCodigobarras, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(vRPanel2, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
