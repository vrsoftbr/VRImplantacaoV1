...
import vrimplantacao.dao.interfaces.IntelliCashDAO;
...
public class IntelliCashGUI extends VRInternalFrame {    
    ...
    private final IntelliCashDAO intelliCashDAO = new IntelliCashDAO();   
    ...
    public static final String SISTEMA = NOME_SISTEMA;
    ...
    public void carregarLojaCliente() throws Exception {
        ...
        int cont = 0;
        int index = 0;
        for (ItemComboVO loja: intelliCashDAO.getLojasCliente()) {
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    Importador importador = new Importador(intelliCashDAO.getProdutoDao());
