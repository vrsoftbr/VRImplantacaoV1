...
import vrimplantacao.dao.interfaces.EverastDAO;
import vrimplantacao.dao.interfaces.VRSoftwareDAO;
import vrimplantacao.vo.loja.LojaVO;


public class EverastGUI extends VRInternalFrame {

    private EverastDAO importacaoEverast = new EverastDAO();
    ...
    public EverastGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        
        txtHostMySQL.setText("localhost");
        txtBancoDadosMySQL.setText("");
            ...
            public void run() {
                ...
                try {
                    ...
                    if ((!txtArquivoBalanca.getArquivo().isEmpty()) &&
                        ...
                        importacaoEverast.importarProdutoBalanca(txtArquivoBalanca.getArquivo(), opcao);
                    }
            ...
            public void run() {
                try {
                    ...
                    if (chkFamiliaProduto.isSelected()) {                        
                        importacaoEverast.importarFamiliaProduto();
                    }
                    
                    if (chkMercadologico.isSelected()) {
                        importacaoEverast.importarMercadologico();
                    }
                    
                    if (chkProduto.isSelected()) {
                        importacaoEverast.importarProduto(cmbLojaDestino.getSelectedIndex() + 1);
                    }
                    
                    if (chkCustoProduto.isSelected()) {
                        importacaoEverast.importarCustoProduto(id_loja, id_lojaCliente);
                    }                    
                    
                    if (chkPrecoProduto.isSelected()) {
                        importacaoEverast.importarPrecoProduto(cmbLojaDestino.getSelectedIndex() + 1);
                    }                                        
                    
                    if (chkEstoqueProduto.isSelected()) {
                        importacaoEverast.importarEstoqueProduto(id_loja);
                    }                      
                    
                    if (chkCodigoBarrasDuplicados.isSelected()) {
                        importacaoEverast.importarCodigoBarraEmBranco();
                    }
                    
                    if (chkFornecedor.isSelected()) {
                        importacaoEverast.importarFornecedor();
                    } 
                    
                    if (chkProdutoFornecedor.isSelected()) {
                        importacaoEverast.importarProdutoFornecedor();
                    }

                    if (chkClientePreferencial.isSelected()) {
                        importacaoEverast.importarClientePreferencial(id_loja, id_lojaCliente,false);
                    } 
                    
                    if (chkCreditoRotativo.isSelected()) {
                        importacaoEverast.importarReceberCreditoRotativo(id_loja, id_lojaCliente);                        
                    }                                        

                    if (chkChequeReceber.isSelected()) {
                        importacaoEverast.importarChequeReceber(id_loja, id_lojaCliente);
                    }
                    
                    if (chkNaturezaReceita.isSelected()) {
                        importacaoEverast.importarNaturezaReceita(id_loja);
                    }   
                    
                    if (chkPisCofins.isSelected()) {
                        importacaoEverast.importarPisCofins(id_loja);
                    }
                    
                    if (!txtFilePisCofins.getArquivo().isEmpty()) {
                        importacaoEverast.importarAcertarPisCofinsExcel(txtFilePisCofins.getArquivo());
                    }

                    if (!txtFileIcms.getArquivo().isEmpty()) {
                        importacaoEverast.importarAcertarIcmsExcel(txtFileIcms.getArquivo());
                    }
                    
                    ProgressBar.dispose();
                    Util.exibirMensagem("Importação Everast realizada com sucesso!", getTitle());
                } catch (Exception ex) {
                    try {                    
                        connMySQL.close();
                    } catch (Exception ex1) {
    ...
    private void initComponents() {
        ...
        txtFilePisCofins = new vrframework.bean.fileChooser.VRFileChooser();
        txtFileIcms = new vrframework.bean.fileChooser.VRFileChooser();
        ...
        chkCodigoBarrasDuplicados.setText("Codigo de Barras Duplicados");

        chkNaturezaReceita.setText("Natureza Receita");

        chkPisCofins.setText("Pis Cofins");

        vRLabel6.setText("Acertar Piscofins");

        vRLabel8.setText("Acertar ICMS");
        ...
        vRPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(vRPanel2Layout.createSequentialGroup()
                ...
                .addGroup(vRPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(vRPanel2Layout.createSequentialGroup()
                        .addGroup(vRPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtFileIcms, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtFilePisCofins, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(vRPanel2, javax.swing.GroupLayout.DEFAULT_SIZE, 249, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(vRPanel3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private vrframework.bean.fileChooser.VRFileChooser txtFileIcms;
    private vrframework.bean.fileChooser.VRFileChooser txtFilePisCofins;
