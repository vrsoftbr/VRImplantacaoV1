...
import vrimplantacao.dao.interfaces.GZSistemasDAO;
import vrimplantacao.vo.loja.LojaVO;

public class GZSistemasGUI extends VRInternalFrame {

    private final GZSistemasDAO gzSistemasDAO = new GZSistemasDAO();
    private List<LojaVO> vLojaDestino = new ArrayList<>();
    private final ConexaoMySQL conn = new ConexaoMySQL();

    public GZSistemasGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        
        txtHost.setText("localhost");
        txtBancoDados.setText("mercodb");
        txtUsuario.setText("root");
        txtSenha.setText("root");
        txtPorta.setText("3306");
        txtCidadePadrao.setText("3546504");
        txtCepPadrao.setText("15970970");
        txtUFSiglaPadrao.setText("SP");
        chkAcertarEnderecoFornecedor.setVisible(false);
        chkAcertartelefoneFornecedor.setVisible(false);
    ...
    private void carregarLojaCliente() throws Exception {
        ...
        for (ItemComboVO oLoja : gzSistemasDAO.carregarLojasCliente()) {
            ...
            public void run() {
                try {
                    ...
                    if (chkFamiliaProduto.isSelected()) {
                        gzSistemasDAO.importarFamiliaProduto();
                    }
                    
                    if (chkMercadologico.isSelected()) {
                        gzSistemasDAO.importarMercadologico();
                    }
                    
                    if (chkProdutos.isSelected()) {
                        gzSistemasDAO.importarProduto(idLojaVR, idLojaCliente);
                    }

                    if (chkMargem.isSelected()) {
                        gzSistemasDAO.importarListaMargemProduto(idLojaVR, idLojaCliente);
                    }
                    
                    if (chkPreco.isSelected()) {
                        gzSistemasDAO.importarListaPrecoProduto(idLojaVR, idLojaCliente);
                    }
                    
                    if (chkCusto.isSelected()) {
                        gzSistemasDAO.importarListaCustoProduto(idLojaVR, idLojaCliente);
                    }
                    
                    if (chkEan.isSelected()) {
                        gzSistemasDAO.importarListaDeCodigoBarrasProduto(idLojaVR, idLojaCliente);
                    }
                    
                    if (chkEanEmBranco.isSelected()) {
                        gzSistemasDAO.importarCodigoBarraEmBranco();
                    }
                    
                    if (chkEstoque.isSelected()) {
                        gzSistemasDAO.importarListaDeEstoqueProduto(idLojaVR, idLojaCliente);
                    }
                    
                    if (chkSituacaoCadastro.isSelected()) {
                        gzSistemasDAO.importarListaSituacaoCadastroProduto(idLojaVR, idLojaCliente);
                    }
                    
                    if (chkFornecedor.isSelected()) {
                        gzSistemasDAO.importarFornecedor();
                    }
                    
                    if (chkProdutoFornecedor.isSelected()) {
                        gzSistemasDAO.importarProdutoFornecedor();
                    }
                    
                    if (chkAcertarEnderecoFornecedor.isSelected()) {
                        gzSistemasDAO.importarAcertarEnderecoFornecedor();
                    }
                    
                    if (chkAcertartelefoneFornecedor.isSelected()) {
                        gzSistemasDAO.importarAcertarTelefoneFornecedor();
                    }
                    
                    if (chkClientePreferencial.isSelected()) {
                        gzSistemasDAO.importarClientePreferencial(idLojaVR, idLojaCliente);
                    }
                    
                    if (chkReceberCreditoRotativo.isSelected()) {
                        gzSistemasDAO.importarReceberCreditoRotativo(idLojaVR, idLojaCliente);
                    }
                    
                    ProgressBar.dispose();
                    Util.exibirMensagem("Importação GZ Sistemas realizada com sucesso!", getTitle());
                } catch (Exception ex) {
                    try {                    
                        conn.close();
                    } catch (Exception ex1) {
    ...
    private void initComponents() {
                ...
                .addGroup(vRPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(vRPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(vRPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(vRPanel1Layout.createSequentialGroup()
                                .addComponent(cmbLojaCliente, 0, 184, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        tab.addTab("Valores Padrão", vRPanel6);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(vRPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 621, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tab, javax.swing.GroupLayout.DEFAULT_SIZE, 320, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
