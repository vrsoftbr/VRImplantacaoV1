...
import vrimplantacao.dao.interfaces.PlanilhaCodigoBarrasLeaoDAO;
import vrimplantacao.dao.interfaces.PlanilhaContasReceberDAO;
import vrimplantacao.vo.loja.LojaVO;

public class PlanilhaCodigoBarrasLeaoGUI extends VRInternalFrame {

    public PlanilhaCodigoBarrasLeaoGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    new PlanilhaCodigoBarrasLeaoDAO().migrarCodigoAnterior2(flcArquivoProduto.getArquivo(), cmbLojaDestino.getId());
    ...
    private void initComponents() {
        ...
        setTitle("Migração Planilha Produto - Codigo Barra");
        setToolTipText("");

        vRPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Dados Origem"));
        vRPanel1.setPreferredSize(new java.awt.Dimension(350, 350));

        vRLabel1.setText("Planilha Produto - Codigo Barra");
