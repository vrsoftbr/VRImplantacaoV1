...
import vrimplantacao.dao.interfaces.SysMouraDAO;
import vrimplantacao.vo.loja.LojaVO;

public class SysMouraGUI extends VRInternalFrame {

    private final SysMouraDAO sysMouraDAO = new SysMouraDAO();
    private List<LojaVO> vLojaDestino = new ArrayList<>();
    private final ConexaoSqlServer conn = new ConexaoSqlServer();

    public SysMouraGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        
        txtHost.setText("servidor-pc");
        txtBancoDados.setText("sismoura");
        txtUsuario.setText("sa");
        txtSenha.setText("epilef");
    ...
    private void carregarLojaCliente() throws Exception {
        ...
        for (ItemComboVO oLoja : sysMouraDAO.carregarLojasCliente()) {
    ...
    private void carregarDepositos() throws Exception {        
        ...
        int idLoja = ((ItemComboVO) cmbLojaCliente.getSelectedItem()).id;
        for (ItemComboVO oLoja : sysMouraDAO.carregarDepositos(idLoja)) {
            cmbDeposito.addItem(oLoja);
        }
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    sysMouraDAO.setDeposito(((ItemComboVO) cmbDeposito.getSelectedItem()).id);
                    
                    if (chkMercadologico.isSelected()) {
                        sysMouraDAO.importarMercadologico();
                    }
                    
                    if (chkProdutos.isSelected()) {
                        sysMouraDAO.importarProduto(idLojaVR, idLojaCliente);
                    }
                    
                    if (chkEan.isSelected()) {
                        sysMouraDAO.importarEanProduto(idLojaVR, idLojaCliente);
                    }
                    
                    if (chkEanEmBranco.isSelected()) {
                        sysMouraDAO.importarCodigoBarraEmBranco();
                    }
                    
                    if (chkPreco.isSelected()) {
                        sysMouraDAO.importarPrecoProduto(idLojaVR, idLojaCliente);
                    }
                    
                    if (chkCusto.isSelected()) {
                        sysMouraDAO.importarCustoProduto(idLojaVR, idLojaCliente);
                    }
                    
                    if (chkEstoque.isSelected()) {
                        sysMouraDAO.importarEstoqueProduto(idLojaVR, idLojaCliente);
                    }
                    
                    if (chkFornecedor.isSelected()) {
                        sysMouraDAO.importarFornecedor();
                    }
                    
                    if (chkProdutoFornecedor.isSelected()) {
                        sysMouraDAO.importarProdutoFornecedor();
                    }
                    
                    if (chkClientePreferencial.isSelected()) {
                        sysMouraDAO.importarClientePreferencial(idLojaVR, idLojaCliente);
                    }
                    
                    ProgressBar.dispose();
                    Util.exibirMensagem("Importação SysMoura realizada com sucesso!", getTitle());
                } catch (Exception ex) {
                    try {                    
                        conn.close();
                    } catch (Exception ex1) {
    ...
    private void initComponents() {
        ...
        vRPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(vRPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, vRPanel6Layout.createSequentialGroup()
                    .addGap(78, 78, 78)
                    .addComponent(cmbDeposito, 0, 106, Short.MAX_VALUE)
                    .addContainerGap()))
        );
        vRPanel6Layout.setVerticalGroup(
            ...
            .addGroup(vRPanel6Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(chkEstoque, javax.swing.GroupLayout.DEFAULT_SIZE, 27, Short.MAX_VALUE)
                .addContainerGap())
            .addGroup(vRPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(vRPanel6Layout.createSequentialGroup()
                    .addGap(10, 10, 10)
                    .addComponent(cmbDeposito)
                    .addContainerGap()))
        );
        ...
        vRPanel2Layout.setVerticalGroup(
            ...
            .addGroup(vRPanel2Layout.createSequentialGroup()
                .addGroup(vRPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(vRPanel6, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        pnlImportarDadosLayout.setVerticalGroup(
            pnlImportarDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlImportarDadosLayout.createSequentialGroup()
                .addContainerGap()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tab, javax.swing.GroupLayout.DEFAULT_SIZE, 273, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
