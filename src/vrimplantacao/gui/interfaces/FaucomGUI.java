...
import vrimplantacao.dao.interfaces.FaucomDAO;
import vrimplantacao.vo.loja.LojaVO;

public class FaucomGUI extends VRInternalFrame {

    private FaucomDAO importacaoFaucom = new FaucomDAO();
    private List<LojaVO> vLojaDestino = new ArrayList<>();
    private ConexaoSqlServer connSQLServer = new ConexaoSqlServer();

    public FaucomGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();

        txtHostSqlServer.setText("localhost");
        txtBancoDadosSqlServer.setText("BDFAUCOM");
        txtUsuarioSqlServer.setText("sa");
        txtSenhaSqlServer.setText("vrimplantacao");
        txtPortaSqlServer.setText("1433");
        txtCidadePadrao.setText("2303709");
        txtCepPadrao.setText("61658730");
        txtCidadeDescricaoPadrao.setText("CAUCAIA");
        txtUFSiglaPadrao.setText("CE");        
            ...
            public void run() {
                ...
                try {
                    ...
                    if ((!txtArquivoBalanca.getArquivo().isEmpty())
                        ...
                        importacaoFaucom.importarProdutoBalanca(txtArquivoBalanca.getArquivo(), opcao);
                    }
            ...
            public void run() {
                try {
                    ...
                    if (chkFamiliaProduto.isSelected()) {
                        importacaoFaucom.importarFamiliaProduto();
                    }

                    if (chkMercadologico.isSelected()) {
                        importacaoFaucom.importarMercadologico();
                    }

                    if (chkProduto.isSelected()) {
                        importacaoFaucom.importarProduto(id_loja, id_lojaCliente);
                    }

                    if (chkCustoProduto.isSelected()) {
                        importacaoFaucom.importarListaCustoProduto(id_loja, id_lojaCliente);
                    }

                    if (chkPrecoProduto.isSelected()) {
                        importacaoFaucom.importarListaPrecoProduto(id_loja, id_lojaCliente);
                    }

                    if (chkEstoqueProduto.isSelected()) {
                        importacaoFaucom.importarListaDeEstoqueProduto(id_loja, id_lojaCliente);
                    }

                    if (chkCodigoBarras.isSelected()) {
                        importacaoFaucom.importarListaDeCodigoBarrasProduto(id_loja, id_lojaCliente);
                    }

                    if (chkProdutoSemEAN.isSelected()) {
                        importacaoFaucom.importarCodigoBarraEmBranco();
                    }

                    if (chkCodigoBarrasAtacado.isSelected()) {
                        //importacaoGetWay.importarCodigoBarrasAtacadoLoja(id_loja);
                    }
                    ...
                    if (chkFornecedor.isSelected()) {
                        importacaoFaucom.importarFornecedor();
                    }
                    
                    if (chkProdutoFornecedor.isSelected()) {
                        importacaoFaucom.importarProdutoFornecedor();
                    }

                    if (chkContasPagar.isSelected()) {
                        //importacaoFaucom.importarContasPagar(id_loja, id_lojaCliente);
                    }

                    if (chkClientePreferencial.isSelected()) {
                        importacaoFaucom.importarClientePreferencial(id_loja, id_lojaCliente);
                    }
                    
                    if (chkCreditoRotativo.isSelected()) {
                        importacaoFaucom.importarReceberCreditoRotativo(id_loja, id_lojaCliente);
                    }
                    ...
                    if (chkCustoIntegracao.isSelected()) {
                        //importacaoGetWay.importarCustoProdutoIntegracaoGetWay(id_loja, id_lojaCliente);
                    }
                    
                    if (chkPrecoIntegracao.isSelected()) {
                        //importacaoGetWay.importarPrecoProdutoIntegracaoGetWay(id_loja, id_lojaCliente);
                    }
                    ...
                    if (chkReceberChequeCondicao.isSelected()) {
                        //importacaoGetWay.importarReceberChequeComCondicaoGetWay(id_loja, id_lojaCliente);
                    }
                    
                    if (chkAcertarProdutoFamilia.isSelected()) {
                        importacaoFaucom.importarProdutoFamilia(id_loja, id_lojaCliente);
                    }
                    ProgressBar.dispose();
                    Util.exibirMensagem("Importação Faucom realizada com sucesso!", getTitle());
                } catch (Exception ex) {
                    try {
                        connSQLServer.close();
                    } catch (Exception ex1) {
    ...
    private void initComponents() {
        ...
        vRPanel6Layout.setVerticalGroup(
            ...
            .addGroup(vRPanel6Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(vRPanel8, javax.swing.GroupLayout.PREFERRED_SIZE, 79, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        vRPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(vRPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(txtArquivoBalanca, javax.swing.GroupLayout.PREFERRED_SIZE, 429, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(vRPanel1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 774, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(vRTabbedPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 328, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
