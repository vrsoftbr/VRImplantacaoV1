...
public class InteragemGUI_2 extends VRInternalFrame {
    ...
    private static final String SISTEMA = "Interagem";
    ...
    private InteragemDAO interagemDAO = new InteragemDAO();
    ...
    public InteragemGUI_2(VRMdiFrame i_mdiFrame) throws Exception {
        ...
        this.title = "Importação " + SISTEMA + " 2";
        carregarParametros();
    ...
    public void carregarLojaCliente() throws Exception {
        ...
        int cont = 0;
        int index = 0;
        for (Estabelecimento loja: interagemDAO.getLojasCliente()) {
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    Importador importador = new Importador(interagemDAO);
                    importador.setLojaOrigem(idLojaCliente);
                    importador.setLojaVR(idLojaVR);

                    if (!txtLojaID.getText().trim().isEmpty()) {
                        interagemDAO.id_loja = " - " + txtLojaID.getText();
                    } else {
                        interagemDAO.id_loja = "";
                    }
                    ...
                    if (tabs.getSelectedIndex() == 0) {
                        ...
                        if (chkEanAtacado.isSelected()) {
                            importador.importarEANAtacado();
                        }
                        ...
                        interagemDAO.i_arquivoXLS = flcAcertarEstoque.getArquivo();
                        List<OpcaoProduto> opcoes2 = new ArrayList<>();
                        if (!interagemDAO.i_arquivoXLS.isEmpty()) {
                            opcoes2.add(OpcaoProduto.ESTOQUE);
                        }
                        if (!opcoes2.isEmpty()) {
                            importador.atualizarProdutos(opcoes2);
                        }
                    }
    ...
    private void initComponents() {
        ...
        flcAcertarEstoque = new vrframework.bean.fileChooser.VRFileChooser();
        vRImportaArquivBalancaPanel1 = new vrimplantacao.gui.componentes.importabalanca.VRImportaArquivBalancaPanel();

        setTitle("Importação Interagem 2");
        setToolTipText("");
                ...
                .addGroup(vRPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(vRPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(vRPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(vRPanel1Layout.createSequentialGroup()
                                .addComponent(txtLojaID, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        chkEanAtacado.setText("EAN Atacado");
        ...
        vRPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(vRPanel9Layout.createSequentialGroup()
                ...
                .addGroup(vRPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(vRPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, vRPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(chkT1Margem, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        vRPanel9Layout.setVerticalGroup(
            ...
            .addGroup(vRPanel9Layout.createSequentialGroup()
                ...
                .addGroup(vRPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(vRPanel9Layout.createSequentialGroup()
                        .addGroup(vRPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(chkEanAtacado, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(vRPanel9Layout.createSequentialGroup()
                                .addComponent(chkT1EAN, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(23, 23, 23)))
        ...
        vRTabbedPane1.addTab("Produto", vRPanel9);
        ...
        vRLabel6.setText("Acertar Estoque");
            ...
            .addGroup(vRPanel8Layout.createSequentialGroup()
                ...
                .addGroup(vRPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(vRPanel8Layout.createSequentialGroup()
                        ...
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addComponent(flcAcertarEstoque, javax.swing.GroupLayout.DEFAULT_SIZE, 497, Short.MAX_VALUE))
                .addContainerGap())
        );
        vRPanel8Layout.setVerticalGroup(
            ...
            .addGroup(vRPanel8Layout.createSequentialGroup()
                ...
                .addComponent(vRLabel6, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(flcAcertarEstoque, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(vRPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 526, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private vrframework.bean.fileChooser.VRFileChooser flcAcertarEstoque;
