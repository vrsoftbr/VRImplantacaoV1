...
import vrimplantacao.vo.ParametroVO;
import vrframework.classe.Conexao;

public class ParametroPdvDAO {
    ...
    public ParametroVO get(int i_id) throws Exception {
        ...
        sql.append(" FROM pdv.parametro AS p");
        sql.append(" LEFT JOIN pdv.parametrovalor AS pv ON pv.id_parametro = p.id AND pv.id_loja = " + Global.idLoja);
