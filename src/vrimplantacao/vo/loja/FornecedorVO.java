...
public class FornecedorVO {
    ...
    public String enderecoAnterior = "";
    public String numero = "";
    public String numeroAnterior = "";
    public String complemento = "";
    public String bairro = "";
    public String bairroAnterior = "";
    public String municipio = "";
    public int idMunicipio = 0;
    public int idMunicipioAnterior = 0;
    public int idPais = 0;
    public int idPaisAnterior = 0;
    public int cep = 0;
    ...
    public String inscricaoEstadualAnterior = "";
    public long cnpj = 0;
    public long cnpjAnterior = 0;
    ...
    public String inscricaoSuframaAnterior = "";
    ...
    public int idContaContabilFiscal = 3;
    ...
    public void setDadosAdicionais(String dadosAdicionais) {
        this.observacao = dadosAdicionais;
    }
