...
public final class SQLUtils {
     ...
     * auxiliar na criação de SQLUtils.
     *
    ...
    /**
     * Formata um número inteiro para ser utilizado no comando SQLUtils. Caso o
     * número informado seja igual ao nullValue então "null" é retornado.
     *
     * @param number Número a ser convertido.
     * @param nullValue Caso o number seja igual a esse valor "null" é
     * retornado.
    ...
    /**
     * Formata um número double para ser utilizado no comando SQLUtils. Caso o
     * número informado seja igual ao nullValue então "null" é retornado.
     *
     * @param number Número a ser convertido.
     * @param nullValue Caso o number seja igual a esse valor "null" é
     ...
     * intervalos menores de um mês. Coloque as tags {DATA_INICIO} e
     * {DATA_TERMINO} onde deverá ser substituído por uma data do intervalo
     * gerado.
     *
     ...
     * @return Lista de comandos SQL com as datas substituidas pelos intervalos
     * menores.
     */
    ...
    public static List<Intervalo> intervalosMensais(Date dataInicio, Date dataTermino) {
        ...
        if (termino.isBefore(inicio)) {
            throw new RuntimeException("Data final menor que a data inicial");
        }
    ...
    public static List<Intervalo> intervalosDiarios(Date dataInicio, Date dataTermino) {
        DateTime inicio = new DateTime(dataInicio.getTime());
        DateTime termino = new DateTime(dataTermino.getTime());
        ...
        do {
            ...
            result.add(new Intervalo(new Date(inicio.getMillis()), new Date(prox.getMillis())));
            inicio = prox.plusDays(1);
        } while (inicio.isBefore(termino) || inicio.equals(termino));
