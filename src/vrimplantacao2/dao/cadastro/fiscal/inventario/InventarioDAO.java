...
public class InventarioDAO {
    ...
    public MultiMap<String, InventarioVO> getInventario(int idLojaVR, int idProduto, Date data) throws Exception {
        MultiMap<String, InventarioVO> result = new MultiMap<>();
        try (Statement stm = Conexao.createStatement()) {
