...
public class GTechDAO extends InterfaceDAO implements MapaTributoProvider {
    ...
    private ProdutoIMP converterIMP(ResultSet rs, Map<Integer, ProdutoBalancaVO> balancas, Set<String> identificarBalanca) throws SQLException {
