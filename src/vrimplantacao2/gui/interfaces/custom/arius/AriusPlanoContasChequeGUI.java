 ...
 * @author Leandro
 */
public class AriusPlanoContasRotativoGUI extends JPanel {
    
    private static final Logger LOG = Logger.getLogger(AriusPlanoContasRotativoGUI.class.getName());
     ...
     */
    public AriusPlanoContasRotativoGUI() {
        initComponents();
