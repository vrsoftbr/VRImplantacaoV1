...
public class SaacGUI extends VRInternalFrame {
    ...
    private static final String SISTEMA = "Saac";
    private static final String SERVIDOR_SQL = "Firebird";
    private static SaacGUI instance;

    private String vLojaCliente = "-1";
    private int vLojaVR = -1;

    private SaacDAO saacDAO = new SaacDAO();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new SaacGUI(i_mdiFrame);
            }
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    Importador importador = new Importador(saacDAO);
