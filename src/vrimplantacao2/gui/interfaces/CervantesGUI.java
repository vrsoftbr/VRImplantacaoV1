 ...
 * @author Guilherme
 */
public class CervantesGUI extends VRInternalFrame {
    
    private static final String SISTEMA = "Cervantes";
    private static final Logger LOG = Logger.getLogger(CervantesGUI.class.getName());

    private static CervantesGUI instance;
    
    private String vLojaCliente;
    private int vLojaVR;
    private final CervantesDAO dao;
    
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            i_mdiFrame.setWaitCursor();            
            if (instance == null || instance.isClosed()) {
                instance = new CervantesGUI(i_mdiFrame);
            }
     ...
     */
    public CervantesGUI(VRMdiFrame frame) throws Exception {
        super(frame);
        this.dao = new CervantesDAO();
        initComponents();
        ...
        conexao.database = "InkDB";
        conexao.port = "5433";
        conexao.user = "postgres";
        conexao.pass = "cer_2011!";
