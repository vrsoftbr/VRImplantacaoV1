...
public class MultiPdvGUI extends VRInternalFrame {

    private static final String SISTEMA = "Multipdv";
    private static MultiPdvGUI instance;
    ...
    private MultiPdvDAO multiPdvDAO = new MultiPdvDAO();

    private MultiPdvGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new MultiPdvGUI(i_mdiFrame);
            }
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    multiPdvDAO.v_arquivo = txtDatabase.getArquivo();

                    Importador importador = new Importador(multiPdvDAO);
    ...
    private void initComponents() {
        ...
        chkCustoSemImposto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chkCustoSemImpostoActionPerformed(evt);
            }
        });
            ...
            .addGroup(vRPanel7Layout.createSequentialGroup()
                ...
                .addGroup(vRPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(vRPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addComponent(chkCustoComImposto, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        vRPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder("Dados Origem - Arquivo"));
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtDatabase, javax.swing.GroupLayout.PREFERRED_SIZE, 182, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(vRPanel6, javax.swing.GroupLayout.DEFAULT_SIZE, 556, Short.MAX_VALUE)
        ...
        vRPanel6.getAccessibleContext().setAccessibleName("Dados Origem - Arquivo");

        getAccessibleContext().setAccessibleName("Importação MultiPdv");
    ...
    private void chkCustoSemImpostoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkCustoSemImpostoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_chkCustoSemImpostoActionPerformed
