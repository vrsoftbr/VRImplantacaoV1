...
public class NATISistemasGUI extends VRInternalFrame {

    private static final String SISTEMA = "NATISistemas";
    private static final String SERVIDOR_SQL = "Sql Server";
    private static NATISistemasGUI instance;
    private String vLojaCliente = "-1";
    private int vLojaVR = -1;
    private NATISistemasDAO natiSistemasDAO = new NATISistemasDAO();
    private ConexaoSqlServer connSqlServer = new ConexaoSqlServer();
    private Object NatiSistemasDAO;
    ...
    private NATISistemasGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public void carregarLojaCliente() throws Exception {
        ...
        int cont = 0;
        int index = 0;
        for (Estabelecimento loja : natiSistemasDAO.getLojas()) {
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new NATISistemasGUI(i_mdiFrame);
            }
    ...
    private void initComponents() {
        ...
        chkTemArquivoBalancaUnificacao.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chkTemArquivoBalancaUnificacaoActionPerformed(evt);
            }
        });
