...
public class CPGestorGUI extends VRInternalFrame {
    
    private static final String SISTEMA = "CPGestor";
    private static final String SERVIDOR_SQL = "Oracle";
    private static CPGestorGUI instance;
    ...
    private CPGestorDAO cpGestorDAO = new CPGestorDAO();
    private ConexaoOracle connOracle = new ConexaoOracle();
    
    private CPGestorGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    /*public void carregarLojaCliente() throws Exception {
        ...
        int cont = 0;
        int index = 0;
        for (Estabelecimento loja: linnerDAO.getLojasCliente()) {
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new CPGestorGUI(i_mdiFrame);
            }
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    cpGestorDAO.i_arquivo = flcTributacaoProduto.getArquivo();
                    ...
                    if (tabs.getSelectedIndex() == 0) {
...

                        {
                            ...
                            if ((chkT1Estoque.isSelected()) && (!flcTributacaoProduto.getArquivo().isEmpty())) {
                                opcoes.add(OpcaoProduto.ESTOQUE);
                            }
                            if ((chkT1PisCofins.isSelected()) && (!flcTributacaoProduto.getArquivo().isEmpty())) {
                                opcoes.add(OpcaoProduto.PIS_COFINS);
                            }
                            if ((chkT1NatReceita.isSelected()) && (!flcTributacaoProduto.getArquivo().isEmpty())) {
                                opcoes.add(OpcaoProduto.NATUREZA_RECEITA);
                            }
                            if ((chkT1ICMS.isSelected()) && (!flcTributacaoProduto.getArquivo().isEmpty())) {
                        ...
                        if (chkOfertas.isSelected()) {
                            cpGestorDAO.importarOfertas(idLojaVR, idLojaVR, idLojaCliente);
                        }
                        
                        if (chkOfertaFamilia.isSelected()) {
                            cpGestorDAO.importarOfertasFamilia(idLojaVR, idLojaVR, idLojaCliente);
                        }
                        ...
                        if (chkreceberDevolucao.isSelected()) {
                            cpGestorDAO.importarReceberDevolucao(idLojaVR);
                        }
                        ...
                        if (!flcPlanilhaProdutos.getArquivo().trim().isEmpty()) {
                            cpGestorDAO.importarProdutosCPGestor(flcPlanilhaProdutos.getArquivo());
                        }
                    }
    ...
    private void initComponents() {
        ...
        flcTributacaoProduto = new vrframework.bean.fileChooser.VRFileChooser();
        ...
        flcPlanilhaProdutos = new vrframework.bean.fileChooser.VRFileChooser();
        ...
        vRLabel1.setText("Tributação Produto");
        ...
        vRPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(vRPanel7Layout.createSequentialGroup()
                ...
                .addGroup(vRPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(flcTributacaoProduto, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(vRPanel7Layout.createSequentialGroup()
                        .addGroup(vRPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        vRLabel2.setText("Planilha Produtos");
        ...
        vRPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(vRPanel1Layout.createSequentialGroup()
                ...
                .addGroup(vRPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(flcPlanilhaProdutos, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private vrframework.bean.fileChooser.VRFileChooser flcPlanilhaProdutos;
    private vrframework.bean.fileChooser.VRFileChooser flcTributacaoProduto;
