...
public class SoftcomGUI extends VRInternalFrame {
    
    private static final String SISTEMA = "Softcom";
    private static final String SERVIDOR_SQL = "SQL Server";
    private static SoftcomGUI instance;
    ...
    private void carregarParametros() throws Exception {
        ...
        txtDatabase.setText(params.getWithNull("", SISTEMA, "DATABASE"));
        txtPorta.setText(params.getWithNull("1433", SISTEMA, "PORTA"));
        txtUsuario.setText(params.getWithNull("sa", SISTEMA, "USUARIO"));
        txtSenha.setText(params.getWithNull("qaz@123", SISTEMA, "SENHA"));
    ...
    private SoftcomDAO dao = new SoftcomDAO();
    private ConexaoSqlServer conn = new ConexaoSqlServer();
    
    private SoftcomGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new SoftcomGUI(i_mdiFrame);
            }
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    dao.setComplemento(txtLComplemento.getText());
    ...
    private void initComponents() {
        ...
        txtLComplemento = new vrframework.bean.textField.VRTextField();
                ...
                .addGroup(vRPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, vRPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(vRPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtLComplemento, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                ...
                .addGroup(vRPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(vRPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(vRPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(txtLComplemento, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel2)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private vrframework.bean.textField.VRTextField txtLComplemento;
