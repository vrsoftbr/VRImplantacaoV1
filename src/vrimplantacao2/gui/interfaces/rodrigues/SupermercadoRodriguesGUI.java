package vrimplantacao2.gui.interfaces.rodrigues;

import vrimplantacao2.gui.interfaces.unificacao.primeiropreco.*;
...
import vrimplantacao2.dao.interfaces.rodrigues.SupermercadoRodriguesDAO;
import vrimplantacao2.dao.interfaces.unificacao.primeiropreco.PrimeiroPrecoDAO;
import vrimplantacao2.parametro.Parametros;

public class SupermercadoRodriguesGUI extends VRInternalFrame {
    
    private static final String SISTEMA = "Supermercado Rodrigues";
    private static final String SERVIDOR_SQL = "Postgres";
    private static SupermercadoRodriguesGUI instance;
    ...
    private SupermercadoRodriguesDAO dao = new SupermercadoRodriguesDAO();
    
    private SupermercadoRodriguesGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new SupermercadoRodriguesGUI(i_mdiFrame);
            }
    ...
    private void initComponents() {
        ...
        setTitle("Correção Mercadológico Supermercado Rodrigues");
        setToolTipText("");
        ...
        vRPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder("Dados Origem"));
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cmbLojaOrigem, javax.swing.GroupLayout.PREFERRED_SIZE, 436, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(vRPanel6, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        getAccessibleContext().setAccessibleName("Correção Mercadológico Supermercado Rodrigues");
