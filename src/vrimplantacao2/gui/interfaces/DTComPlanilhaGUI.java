...
import vrimplantacao2.dao.interfaces.DTComPlanilhaDAO;
...
public class DTComPlanilhaGUI extends VRInternalFrame {

    private static final String SISTEMA = "DTCOM";
    private static DTComPlanilhaGUI instance;
    ...
    private void gravarParametros() throws Exception {
        ...
        params.put(txtTributacaoFile.getArquivo(), SISTEMA, "PLANILHA_FAMILIA");
    ...
    private DTComPlanilhaDAO dao = new DTComPlanilhaDAO();

    private DTComPlanilhaGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        tabProdutos.btnMapaTribut.setProvider(new MapaTributacaoButtonProvider() {
            ...
            public MapaTributoProvider getProvider() {
                dao.setArquivoTributacao(txtTributacaoFile.getArquivo());
                return dao;
            }
            ...
            public String getLoja() {
                ...
                vLojaCliente = dao.getLojaOrigem();
                return vLojaCliente;
            }
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new DTComPlanilhaGUI(i_mdiFrame);
            }
            ...
            public void run() {
                try {
                    ...
                    if (tabsProduto.getSelectedIndex() == 0) {
                        ...
                        dao.setArquivoCEST(txtCestFile.getArquivo());
    ...
    private void initComponents() {
        ...
        txtTributacaoFile = new vrframework.bean.fileChooser.VRFileChooser();
        lblProdutoFile = new vrframework.bean.label.VRLabel();
        txtProdutoFile = new vrframework.bean.fileChooser.VRFileChooser();
        lblFileCest = new vrframework.bean.label.VRLabel();
        txtCestFile = new vrframework.bean.fileChooser.VRFileChooser();
        ...
        lblFileFamilia.setText("Planilha de Tributação (aliquot.dbf)");

        lblProdutoFile.setText("Planilha Produto Principal (produtos.dbf)");

        lblFileCest.setText("Planilha de CEST (Cest.dbf)");
        ...
        tabArquivosLayout.setHorizontalGroup(
            ...
            .addGroup(tabArquivosLayout.createSequentialGroup()
                ...
                .addGroup(tabArquivosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtTributacaoFile, javax.swing.GroupLayout.DEFAULT_SIZE, 697, Short.MAX_VALUE)
                    .addComponent(txtProdutoFile, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(txtCestFile, javax.swing.GroupLayout.DEFAULT_SIZE, 697, Short.MAX_VALUE)
                    .addGroup(tabArquivosLayout.createSequentialGroup()
                        .addGroup(tabArquivosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(lblFileCest, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
        tabArquivosLayout.setVerticalGroup(
            ...
            .addGroup(tabArquivosLayout.createSequentialGroup()
                ...
                .addComponent(lblFileFamilia, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtTributacaoFile, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblFileCest, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtCestFile, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblProdutoFile, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(tabPrincipal, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private vrframework.bean.label.VRLabel lblFileCest;
    ...
    private vrframework.bean.fileChooser.VRFileChooser txtCestFile;
    ...
    private vrframework.bean.fileChooser.VRFileChooser txtTributacaoFile;
