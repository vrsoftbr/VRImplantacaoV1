...
import vrimplantacao2.dao.interfaces.Stock_PostgresDAO;
 ...
 * @author Alan
 */
public class Stock_PostgresGUI extends VRInternalFrame {

    private static final String SISTEMA = "Stock";

    private static Stock_PostgresGUI instance;

    private String vLojaCliente;
    private int vLojaVR;
    private final Stock_PostgresDAO dao;

    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            i_mdiFrame.setWaitCursor();
            if (instance == null || instance.isClosed()) {
                instance = new Stock_PostgresGUI(i_mdiFrame);
            }
     ...
     */
    public Stock_PostgresGUI(VRMdiFrame frame) throws Exception {
        super(frame);
        this.dao = new Stock_PostgresDAO();
        initComponents();
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Importação Stock Postgres");
