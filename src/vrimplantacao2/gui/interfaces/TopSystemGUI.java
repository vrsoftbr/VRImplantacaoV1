...
public class TopSystemGUI extends VRInternalFrame {
    ...
    private static TopSystemGUI instance;
    private TopSystemDAO topSystemDAO = new TopSystemDAO();
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    Importador importador = new Importador(topSystemDAO);
    ...
    private void initComponents() {
        ...
        pnlImportarDadosLayout.setHorizontalGroup(
            ...
            .addGroup(pnlImportarDadosLayout.createSequentialGroup()
                ...
                .addGroup(pnlImportarDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(vRPanel2, javax.swing.GroupLayout.PREFERRED_SIZE, 577, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tabs, javax.swing.GroupLayout.DEFAULT_SIZE, 335, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
