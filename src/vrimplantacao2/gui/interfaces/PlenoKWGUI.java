...
public class PlenoKWGUI extends VRInternalFrame implements ConexaoEvent {

    private static final String SISTEMA = "PlenoKW";
    private static PlenoKWGUI instance;
    ...
    private PlenoKWDAO dao = new PlenoKWDAO();

    private PlenoKWGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new PlenoKWGUI(i_mdiFrame);
            }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(tabs, javax.swing.GroupLayout.DEFAULT_SIZE, 529, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
