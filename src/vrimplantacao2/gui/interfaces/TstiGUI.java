...
public class TstiGUI extends VRInternalFrame {
    ...
    private TstiDAO tstiDAO = new TstiDAO();
    private ConexaoMySQL connMySql = new ConexaoMySQL();
    
    private TstiGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        this.title = "Importação " + SISTEMA;
            ...
            public String getSistema() {
                return tstiDAO.getSistema();
            }

            @Override
            public String getLoja() {
                tstiDAO.setLojaOrigem(((Estabelecimento) cmbLojaOrigem.getSelectedItem()).cnpj);
                return tstiDAO.getLojaOrigem();
            }
    ...
    public void carregarLojaCliente() throws Exception {
        ...
        int cont = 0;
        int index = 0;
        for (Estabelecimento loja: tstiDAO.getLojasCliente()) {
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new TstiGUI(i_mdiFrame);
            }
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    Importador importador = new Importador(tstiDAO);
    ...
    private void initComponents() {
        ...
        vRPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder("Dados Origem - MySQL"));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(vRImportaArquivBalancaPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
