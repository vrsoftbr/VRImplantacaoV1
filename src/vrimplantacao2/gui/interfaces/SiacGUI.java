...
public class SiacGUI extends VRInternalFrame implements ConexaoEvent {

    private static final String SISTEMA = "Siac";
    private static SiacGUI instance;
    ...
    private SiacDAO dao = new SiacDAO();

    private SiacGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        conexaoOracle.database = "master";
        conexaoOracle.port = "1521";
        conexaoOracle.user = "admin";
        conexaoOracle.pass = "manager";
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new SiacGUI(i_mdiFrame);
            }
                ...
                try {
                    ...
                    if (tabOperacoes.getSelectedIndex() == 0) {
                        ...
                        if (chkProdutos.isSelected()) {
                            importador.importarProduto(false, true);
                        }
    ...
    private void initComponents() {
        ...
        pnlLojaLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlLojaLayout.createSequentialGroup()
                ...
                .addComponent(cmbLojaVR, javax.swing.GroupLayout.DEFAULT_SIZE, 319, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(conexaoOracle, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(conexaoOracle, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
