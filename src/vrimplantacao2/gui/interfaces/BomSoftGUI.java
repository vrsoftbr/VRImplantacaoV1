...
import vrimplantacao2.dao.interfaces.BomSoftDAO;
import vrimplantacao2.dao.interfaces.Importador;
import vrimplantacao2.gui.component.mapatributacao.MapaTributoProvider;
import vrimplantacao2.gui.component.mapatributacao.mapatributacaobutton.MapaTributacaoButtonProvider;
import vrimplantacao2.parametro.Parametros;

public class BomSoftGUI extends VRInternalFrame {

    private static final String NOME_SISTEMA = "BomSoft";
    private static final String SERVIDOR_SQL = "Firebird";
    private static BomSoftGUI instance;

    private final BomSoftDAO dao = new BomSoftDAO();
    ...
    private void carregarParametros() throws Exception {
        ...
        txtBancoDadosFirebird.setArquivo(params.getWithNull("C:\\bomsoft\\erp\\dados\\dados.FDB", NOME_SISTEMA, "DATABASE"));
    ...
    private BomSoftGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new BomSoftGUI(i_mdiFrame);
            }
