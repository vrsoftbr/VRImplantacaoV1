...
public class SiaCriareMySqlGUI extends VRInternalFrame {
    ...
    private static final String SISTEMA = "SiaCriareMySQL";
    private static SiaCriareMySqlGUI instance;
    private SiaCriareMySqlDAO dao = new SiaCriareMySqlDAO();
    ...
    private SiaCriareMySqlGUI(VRMdiFrame i_mdiFrame) throws Exception {
        ...
        connMsql.host = "localhost";
        connMsql.port = "3306";
        connMsql.database = "bdsia";
        connMsql.user = "root";
        connMsql.pass = "Hs8Tw13kPx7uDPs";
        
        connMsql.setSistema(SISTEMA);
        connMsql.setOnConectar(new ConexaoEvent() {
            @Override
    ...
    private void initComponents() {
        ...
        connMsql = new vrimplantacao2.gui.component.conexao.mysql.ConexaoMySQLPanel();
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(connMsql, javax.swing.GroupLayout.DEFAULT_SIZE, 561, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(connMsql, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    ...
                    .addComponent(vRLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tabs, javax.swing.GroupLayout.DEFAULT_SIZE, 217, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void cmbLojaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbLojaActionPerformed
        dao.setLojaOrigem(((Estabelecimento) cmbLoja.getSelectedItem()).cnpj);
    ...
    private vrimplantacao2.gui.component.conexao.mysql.ConexaoMySQLPanel connMsql;
