...
import vrimplantacao2.dao.interfaces.SiaCriareDbfDAO;
import vrimplantacao2.gui.component.mapatributacao.MapaTributoProvider;
import vrimplantacao2.gui.component.mapatributacao.mapatributacaobutton.MapaTributacaoButtonProvider;
import vrimplantacao2.parametro.Parametros;

public class SiaCriareMySqlGUI extends VRInternalFrame {
    
    private static final String SISTEMA = "SiaCriareDbf";
    private static final String SERVIDOR_SQL = "Dbf";
    private static SiaCriareMySqlGUI instance;
    private SiaCriareDbfDAO dao = new SiaCriareDbfDAO();
    ...
    private void gravarParametros() throws Exception {
        ...
        Estabelecimento cliente = (Estabelecimento) cmbLoja.getSelectedItem();
        if (cliente != null) {
    ...
    private SiaCriareMySqlGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public void validarDadosAcesso() throws Exception {
        dao.i_arquivo = txtDatabase.getText();
        gravarParametros();
        carregarLojaCliente();
        carregarLojaVR();
    ...
    public void carregarLojaCliente() throws Exception {
        ...
        for (Estabelecimento loja : dao.getLojas()) {
            cmbLoja.addItem(loja);
            if (vLojaCliente != null && vLojaCliente.equals(loja.cnpj)) {
                index = cont;
            }
            cont++;
        }
        cmbLoja.setSelectedIndex(index);
    }
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new SiaCriareMySqlGUI(i_mdiFrame);
            }
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    idLojaCliente = ((Estabelecimento) cmbLoja.getSelectedItem()).cnpj;                    
                    dao.i_arquivo = txtDatabase.getText();
                    dao.v_pahtFileXls = txtArquivoXls.getText();
    ...
    private void initComponents() {
        ...
        chkIdFamilia = new vrframework.bean.checkBox.VRCheckBox();
        ...
        txtArquivoXls = new vrframework.bean.textField.VRTextField();
        ...
        chkIdFamilia.setText("Id Familia Produto");
                    ...
                    .addGroup(vRPanel7Layout.createSequentialGroup()
                        ...
                        .addGroup(vRPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(vRPanel7Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(chkIdFamilia, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtDatabase, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        tabsConn.addTab("Balança", vRImportaArquivBalancaPanel1);
        ...
        vRLabel2.setText("Diretório para arquivo .xls");
        ...
        vRPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(vRPanel6Layout.createSequentialGroup()
                ...
                .addGroup(vRPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(tabsConn, javax.swing.GroupLayout.DEFAULT_SIZE, 541, Short.MAX_VALUE)
                    .addComponent(cmbLoja, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(txtArquivoXls, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(vRPanel6Layout.createSequentialGroup()
                        .addGroup(vRPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        vRPanel6Layout.setVerticalGroup(
            vRPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(vRPanel6Layout.createSequentialGroup()
                .addComponent(tabsConn, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(vRLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtArquivoXls, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(vRLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addComponent(vRPanel6, javax.swing.GroupLayout.DEFAULT_SIZE, 573, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(vRPanel6, javax.swing.GroupLayout.PREFERRED_SIZE, 245, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tabs, javax.swing.GroupLayout.PREFERRED_SIZE, 238, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void cmbLojaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbLojaActionPerformed
        Estabelecimento est = (Estabelecimento) cmbLoja.getSelectedItem();
        if (est != null) {
    ...
    private vrframework.bean.checkBox.VRCheckBox chkIdFamilia;
    ...
    private vrframework.bean.textField.VRTextField txtArquivoXls;
