...
public class HiperGUI extends VRInternalFrame {

    private static final String NOME_SISTEMA = "Hiper";
    private static final String SERVIDOR_SQL = "SQL Server";
    private static HiperGUI instance;

    private final HiperDAO dao = new HiperDAO();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new HiperGUI(i_mdiFrame);
            }
    ...
    private void initComponents() {
        ...
        chkFornEndereco = new javax.swing.JCheckBox();
        ...
        chkIcmsIndividual.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chkIcmsIndividualActionPerformed(evt);
            }
        });
        ...
        chkCliCpfCNPJ.setText("CPF/CNPJ");
    ...
    private void chkIcmsIndividualActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkIcmsIndividualActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_chkIcmsIndividualActionPerformed
    ...
    private javax.swing.JCheckBox chkFornEndereco;
