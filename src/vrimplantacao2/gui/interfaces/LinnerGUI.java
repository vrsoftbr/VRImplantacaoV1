...
public class LinnerGUI extends VRInternalFrame {
    
    private static final String SISTEMA = "Linner";
    private static final String SERVIDOR_SQL = "Oracle";
    private static LinnerGUI instance;
    ...
    private LinnerDAO linnerDAO = new LinnerDAO();
    private ConexaoOracle connOracle = new ConexaoOracle();
    
    private LinnerGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new LinnerGUI(i_mdiFrame);
            }
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    Importador importador = new Importador(linnerDAO);
