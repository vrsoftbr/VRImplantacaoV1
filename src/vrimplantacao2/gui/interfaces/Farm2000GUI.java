...
public class Farm2000GUI extends VRInternalFrame {
    
    private static final String SISTEMA = "Farm2000";
    private static final String SERVIDOR_SQL = "Paradox";
    private static Farm2000GUI instance;
    ...
    //D:\databases\paradox\marquinhos\Servidor\Home_III\
    private Farm2000DAO dao = new Farm2000DAO();
    private ConexaoParadox conexao = new ConexaoParadox();
    
    private Farm2000GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Farm2000GUI(i_mdiFrame);
            }
