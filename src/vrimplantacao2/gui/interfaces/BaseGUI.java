...
public class BaseGUI extends VRInternalFrame {
    
    private static final String SISTEMA = "Base";
    private static final String SERVIDOR_SQL = "Access";
    private static BaseGUI instance;
    ...
    private void carregarParametros() throws Exception {
        ...
        txtDatabase.setArquivo(params.getWithNull("C:\\vr\\database\\base.mdb", SISTEMA, "DATABASE"));
    ...
    private BaseGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();   
    ...
    public void carregarLojaCliente() throws Exception {
        ...
        int cont = 0;
        int index = 0;
        for (Estabelecimento loja: baseDAO.getLojasCliente()) {
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new BaseGUI(i_mdiFrame);
            }
