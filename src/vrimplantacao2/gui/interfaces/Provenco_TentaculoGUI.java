...
public class Provenco_TentaculoGUI extends VRInternalFrame {

    private static final String NOME_SISTEMA = "Tentaculo";
    private static final String SERVIDOR_SQL = "Firebird";
    private static Provenco_TentaculoGUI instance;

    private final Provenco_TentaculoDAO dao = new Provenco_TentaculoDAO();
    ...
    private Provenco_TentaculoGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Provenco_TentaculoGUI(i_mdiFrame);
            }
