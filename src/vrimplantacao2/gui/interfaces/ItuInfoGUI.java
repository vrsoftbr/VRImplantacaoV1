...
public class ItuInfoGUI extends VRInternalFrame {
    ...
    private static final String SISTEMA = "ItuInfo";

    private static ItuInfoGUI instance;

    private String vLojaCliente;
    private int vLojaVR;
    private final ItuInfoDAO dao;
     ...
     */
    public ItuInfoGUI(VRMdiFrame frame) throws Exception {
        super(frame);
        this.dao = new ItuInfoDAO();
        initComponents();
