...
public class FuturaGUI extends VRInternalFrame {

    private static final String NOME_SISTEMA = "Futura";
    private static final String SERVIDOR_SQL = "Firebird";
    private static FuturaGUI instance;

    private final FuturaDAO dao = new FuturaDAO();
    ...
    private void carregarParametros() throws Exception {
        ...
        txtSenhaFirebird.setText(params.getWithNull("sbofutura", NOME_SISTEMA, "SENHA"));
    ...
    private FuturaGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new FuturaGUI(i_mdiFrame);
            }
