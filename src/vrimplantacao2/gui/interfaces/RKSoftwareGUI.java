...
public class RKSoftwareGUI extends VRInternalFrame {

    private static final String NOME_SISTEMA = "RKSoftware";
    private static final String SERVIDOR_SQL = "Firebird";
    private static RKSoftwareGUI instance;

    private final RKSoftwareDAO dao = new RKSoftwareDAO();
    ...
    private RKSoftwareGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new RKSoftwareGUI(i_mdiFrame);
            }
    ...
    private void initComponents() {
        ...
        setResizable(true);
        setTitle("Importação RK Software");
            ...
            .addGroup(pnlConexaoLayout.createSequentialGroup()
                ...
                .addGroup(pnlConexaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlConexaoLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(pnlConexaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtBancoDadosFirebird, javax.swing.GroupLayout.DEFAULT_SIZE, 273, Short.MAX_VALUE)
                            .addGroup(pnlConexaoLayout.createSequentialGroup()
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(tab, javax.swing.GroupLayout.DEFAULT_SIZE, 600, Short.MAX_VALUE)
