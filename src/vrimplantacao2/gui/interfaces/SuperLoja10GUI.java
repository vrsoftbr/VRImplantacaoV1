...
public class SuperLoja10GUI extends VRInternalFrame implements ConexaoEvent {

    private static final String SISTEMA = "SuperLoja10";
    private static SuperLoja10GUI instance;
    ...
    private SuperLoja10DAO dao = new SuperLoja10DAO();

    private SuperLoja10GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new SuperLoja10GUI(i_mdiFrame);
            }
