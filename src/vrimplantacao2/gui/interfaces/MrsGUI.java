...
public class MrsGUI extends VRInternalFrame implements ConexaoEvent {

    private static final String SISTEMA = "Mrs";
    private static MrsGUI instance;
    ...
    private MrsDAO dao = new MrsDAO();

    private MrsGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new MrsGUI(i_mdiFrame);
            }
            ...
            public void run() {
                try {
                    ...
                    if (tabOperacoes.getSelectedIndex() == 0) {
                        ...
                        if (chkConvenioTransacao.isSelected()) {
    ...
    private void initComponents() {
        ...
        chkConvenioTransacao = new vrframework.bean.checkBox.VRCheckBox();
        ...
        chkConvenioTransacao.setText("Convenio Transação");
        ...
        tabClientesLayout.setHorizontalGroup(
            ...
            .addGroup(tabClientesLayout.createSequentialGroup()
                ...
                .addGroup(tabClientesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(chkConvenioTransacao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(tabs, javax.swing.GroupLayout.DEFAULT_SIZE, 493, Short.MAX_VALUE))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tabOperacoes, javax.swing.GroupLayout.DEFAULT_SIZE, 277, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private vrframework.bean.checkBox.VRCheckBox chkConvenioTransacao;
