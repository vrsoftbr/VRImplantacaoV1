...
public class PlenusGUI extends VRInternalFrame {

    private static final String NOME_SISTEMA = "Plenus";
    private static final String SERVIDOR_SQL = "Firebird";
    private static PlenusGUI instance;

    private final PlenusDAO dao = new PlenusDAO();
    ...
    private void carregarParametros() throws Exception {
        ...
        txtSenhaFirebird.setText(params.getWithNull("plenus", NOME_SISTEMA, "SENHA"));
    ...
    private PlenusGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new PlenusGUI(i_mdiFrame);
            }
    ...
    private void initComponents() {
        ...
        getAccessibleContext().setAccessibleName("Importação Plenus");
    ...
    private void txtEncodingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtEncodingActionPerformed
        // TODO add your handling code here:
