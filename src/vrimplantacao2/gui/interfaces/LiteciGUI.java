...
public class LiteciGUI extends VRInternalFrame {
    ...
    private static final String SISTEMA = "Liteci";
    private static LiteciGUI instance;
    ...
    private void carregarParametros() throws Exception {
        ...
        chkGerarCodigoAtacado.setSelected(params.getBool(false, SISTEMA, "GERAR_ATACADO"));
        txtLojaCliente.setText(params.get(SISTEMA, "COMPLEMENTO"));
    ...
    private void gravarParametros() throws Exception {
        ...
        params.put(chkGerarCodigoAtacado.isSelected(), SISTEMA, "GERAR_ATACADO");
        params.put(txtLojaCliente.getText(), SISTEMA, "COMPLEMENTO");
    ...
    private LiteciGUI(VRMdiFrame i_mdiFrame) throws Exception {
        ...
        conexao.port = "3050";
        conexao.database = "D:\\databases\\firebird\\GDOOR\\DATAGES.gdb";
        conexao.user = "sysdba";
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new LiteciGUI(i_mdiFrame);
            }
    ...
    private void initComponents() {
        ...
        chkBairroForn = new vrframework.bean.checkBox.VRCheckBox();
        ...
        chkGerarCodigoAtacado.setText("Gerar código do atacado");
        chkGerarCodigoAtacado.setEnabled(true);
        chkGerarCodigoAtacado.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chkGerarCodigoAtacadoActionPerformed(evt);
            }
        });
        ...
        tabParametrosLayout.setHorizontalGroup(
            ...
            .addComponent(vRImportaArquivBalancaPanel1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        tabParametrosLayout.setVerticalGroup(
            tabParametrosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(tabParametrosLayout.createSequentialGroup()
                .addComponent(vRImportaArquivBalancaPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, 124, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(chkGerarCodigoAtacado, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(18, Short.MAX_VALUE))
        );

        vRTabbedPane2.addTab("Clientes", tabParametros);
        ...
        tabImpFornecedorLayout.setHorizontalGroup(
            ...
            .addGroup(tabImpFornecedorLayout.createSequentialGroup()
                ...
                .addGroup(tabImpFornecedorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(chkBairroForn, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(conexao, javax.swing.GroupLayout.DEFAULT_SIZE, 568, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtLojaCliente)
                            .addComponent(vRLabel1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGap(12, 12, 12)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel2)
                            .addComponent(cmbLojaOrigem, javax.swing.GroupLayout.Alignment.TRAILING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addContainerGap())
        );
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {cmbLojaOrigem, txtLojaCliente});
    ...
    private void chkGerarCodigoAtacadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkGerarCodigoAtacadoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_chkGerarCodigoAtacadoActionPerformed
    private static final SimpleDateFormat DATE_FORMAT = new SimpleDateFormat("dd/MM/yyyy");

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private vrframework.bean.button.VRButton btnMigrar;
    private vrframework.bean.checkBox.VRCheckBox chkBairroForn;
