...
import vrimplantacao2.dao.interfaces.AutoMacDAO;
import vrimplantacao2.dao.interfaces.Importador;
import vrimplantacao2.gui.component.mapatributacao.MapaTributoProvider;
import vrimplantacao2.gui.component.mapatributacao.mapatributacaobutton.MapaTributacaoButtonProvider;
import vrimplantacao2.parametro.Parametros;

public class AutoMacGUI extends VRInternalFrame {

    private static final String NOME_SISTEMA = "AutoMac";
    private static final String SERVIDOR_SQL = "Firebird";
    private static AutoMacGUI instance;

    private final AutoMacDAO dao = new AutoMacDAO();
    ...
    private AutoMacGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new AutoMacGUI(i_mdiFrame);
            }
