...
public class TecnosoftGUI extends VRInternalFrame {

    private static final String NOME_SISTEMA = "TECNOSOFT";
    private static final String SERVIDOR_SQL = "Firebird";
    private static TecnosoftGUI instance;

    private final TecnosoftDAO dao = new TecnosoftDAO();
    ...
    private void carregarParametros() throws Exception {
        ...
        txtBancoDadosFirebird.setArquivo(params.getWithNull("sav50", NOME_SISTEMA, "DATABASE"));
        ...
        txtSenhaFirebird.setText(params.getWithNull("575dellagnolo442", NOME_SISTEMA, "SENHA"));
    ...
    private TecnosoftGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new TecnosoftGUI(i_mdiFrame);
            }
