...
public class SambaNetV2GUI extends VRInternalFrame implements ConexaoEvent {

    private static final String SISTEMA = "SambaNet";
    private static SambaNetV2GUI instance;
    ...
    private SambaNetV2DAO dao = new SambaNetV2DAO();

    private SambaNetV2GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new SambaNetV2GUI(i_mdiFrame);
            }
                ...
                try {
                    ...
                    if (tabOperacoes.getSelectedIndex() == 0) {
                        ...
                        if (chkCreditoRotativo.isSelected()) {
                            dao.rotativoPDV = txtPDV.getText();
        ...
        tabClientesLayout.setHorizontalGroup(
            ...
            .addGroup(tabClientesLayout.createSequentialGroup()
                ...
                .addGroup(tabClientesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lblPDV)
                    .addComponent(txtPDV, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE))
