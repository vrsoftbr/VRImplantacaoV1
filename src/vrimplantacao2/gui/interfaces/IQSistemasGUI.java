...
public class IQSistemasGUI extends VRInternalFrame implements ConexaoEvent {

    private static final String SISTEMA = "IQSistemas";
    private static IQSistemasGUI instance;
    ...
    private IQSistemasDAO dao = new IQSistemasDAO();

    private IQSistemasGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        conexaoMySQL.database = "sice";
        conexaoMySQL.port = "3306";
        conexaoMySQL.user = "root";
        conexaoMySQL.pass = "p@ssw0rd";
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new IQSistemasGUI(i_mdiFrame);
            }
    ...
    private void initComponents() {
        ...
        setTitle("Importação IQSistemas");
        setToolTipText("");
