...
public class RepleisGUI extends VRInternalFrame {
    
    private static final String SISTEMA = "Repleis";
    private static final String SERVIDOR_SQL = "Firebird";
    private static RepleisGUI instance;
    ...
    private RepleisDAO repleisDAO = new RepleisDAO();
    private ConexaoFirebird connFirebird = new ConexaoFirebird();
    
    private RepleisGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public void carregarLojaCliente() throws Exception {
        ...
        int cont = 0;
        int index = 0;
        for (Estabelecimento loja: repleisDAO.getLojasCliente()) {
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new RepleisGUI(i_mdiFrame);
            }
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    Importador importador = new Importador(repleisDAO);
                    ...
                    if (tabs.getSelectedIndex() == 0) {
                        ...
                        if (chkPagRotativo.isSelected()) {
                            repleisDAO.importarPagamentoRotativo();
                        }
                        ...
                        if (!flcTributacao.getArquivo().isEmpty()) {
                            repleisDAO.getProdutoTributacao(flcTributacao.getArquivo());
                        }
                        if (!flcAlterdataProduto.getArquivo().isEmpty()) {
                            repleisDAO.getCodigoAlterdataProduto(flcAlterdataProduto.getArquivo());
                        }
                        if (!flcAlterdataFornecedor.getArquivo().isEmpty()) {
                            repleisDAO.getCodigoAlterdataFornecedor(flcAlterdataFornecedor.getArquivo());
                        }
                        if (!flcProdutoFornecedor.getArquivo().isEmpty()) {
                            repleisDAO.i_arquivoProdutoFornecedor = flcProdutoFornecedor.getArquivo();
                            importador.importarProdutoFornecedor();
                        }
                        if (!flcFornecedor.getArquivo().isEmpty()) {
                            repleisDAO.i_arquivoProdutoFornecedor = flcFornecedor.getArquivo();
                            importador.importarFornecedor();
                            List<OpcaoFornecedor> opcoes = new ArrayList<>();
                            opcoes.add(OpcaoFornecedor.CONTATOS); 
                            if (!opcoes.isEmpty()) {
    ...
    private void initComponents() {
        ...
        chkPagRotativo = new vrframework.bean.checkBox.VRCheckBox();
        ...
        flcTributacao = new vrframework.bean.fileChooser.VRFileChooser();
        vRLabel2 = new vrframework.bean.label.VRLabel();
        flcAlterdataProduto = new vrframework.bean.fileChooser.VRFileChooser();
        vRLabel3 = new vrframework.bean.label.VRLabel();
        flcAlterdataFornecedor = new vrframework.bean.fileChooser.VRFileChooser();
        vRLabel4 = new vrframework.bean.label.VRLabel();
        flcProdutoFornecedor = new vrframework.bean.fileChooser.VRFileChooser();
        vRLabel5 = new vrframework.bean.label.VRLabel();
        flcFornecedor = new vrframework.bean.fileChooser.VRFileChooser();
        ...
        chkPagRotativo.setText("Pagamento Rotativo");
        chkPagRotativo.setEnabled(true);
        chkPagRotativo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chkPagRotativoActionPerformed(evt);
            }
        });
            ...
            .addGroup(vRPanel9Layout.createSequentialGroup()
                ...
                .addGroup(vRPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(vRPanel9Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(vRPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(chkPagRotativo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        vRLabel1.setText("Acertar Tributação (ICMS, Piscofins, NCM)");

        vRLabel2.setText("Codigo Alterdata Produto");

        vRLabel3.setText("Codigo Alterdata Fornecedor");

        vRLabel4.setText("Importar Produto Forencedor");

        vRLabel5.setText("Fornecedor");
        ...
        vRPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(vRPanel1Layout.createSequentialGroup()
                ...
                .addGroup(vRPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(flcTributacao, javax.swing.GroupLayout.DEFAULT_SIZE, 525, Short.MAX_VALUE)
                    .addComponent(flcAlterdataProduto, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(flcAlterdataFornecedor, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(flcProdutoFornecedor, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(vRPanel1Layout.createSequentialGroup()
                        .addGroup(vRPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(flcFornecedor, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        vRPanel1Layout.setVerticalGroup(
            ...
            .addGroup(vRPanel1Layout.createSequentialGroup()
                ...
                .addComponent(vRLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(flcTributacao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(vRLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(flcAlterdataProduto, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(vRLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(flcAlterdataFornecedor, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(vRLabel5, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(flcFornecedor, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtDatabase, javax.swing.GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void chkPagRotativoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkPagRotativoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_chkPagRotativoActionPerformed
    ...
    private vrframework.bean.checkBox.VRCheckBox chkPagRotativo;
    ...
    private vrframework.bean.fileChooser.VRFileChooser flcAlterdataFornecedor;
    private vrframework.bean.fileChooser.VRFileChooser flcAlterdataProduto;
    private vrframework.bean.fileChooser.VRFileChooser flcFornecedor;
    private vrframework.bean.fileChooser.VRFileChooser flcProdutoFornecedor;
    private vrframework.bean.fileChooser.VRFileChooser flcTributacao;
