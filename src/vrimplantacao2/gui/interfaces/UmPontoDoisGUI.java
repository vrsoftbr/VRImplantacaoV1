...
public class UmPontoDoisGUI extends VRInternalFrame implements ConexaoEvent {
    ...
    private static final String SISTEMA = "1.2 Informatica";
    private static UmPontoDoisGUI instance;
    ...
    private UmPontoDoisDAO umPontoDoisDAO = new UmPontoDoisDAO();

    private UmPontoDoisGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public void carregarLojaCliente() throws Exception {
        ...
        int cont = 0;
        int index = 0;
        for (Estabelecimento loja : umPontoDoisDAO.getLojasCliente()) {
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new UmPontoDoisGUI(i_mdiFrame);
            }
    ...
    private void initComponents() {
        ...
        setTitle("Importação 1.2 Informática");
        setToolTipText("");
