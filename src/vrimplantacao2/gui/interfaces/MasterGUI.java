...
public class MasterGUI extends VRInternalFrame {

    private static final String NOME_SISTEMA = "Master";
    private static final String SERVIDOR_SQL = "Firebird";
    private static MasterGUI instance;
    ...
    private MasterGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new MasterGUI(i_mdiFrame);
            }
        ...
        pnlConexaoLayout.setHorizontalGroup(
            ...
            .addGroup(pnlConexaoLayout.createSequentialGroup()
                ...
                .addGroup(pnlConexaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(pnlConexaoLayout.createSequentialGroup()
                        .addComponent(txtBCODADOS, javax.swing.GroupLayout.PREFERRED_SIZE, 198, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
