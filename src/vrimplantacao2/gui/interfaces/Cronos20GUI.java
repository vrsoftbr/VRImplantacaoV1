...
public class Cronos20GUI extends VRInternalFrame {    
    
    private static final String NOME_SISTEMA = "Cronos20";
    private static final String SERVIDOR_SQL = "Postgres";
    private static Cronos20GUI instance;
    
    private final Cronos20DAO cronos20DAO = new Cronos20DAO();
    ...
    private Cronos20GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        tabProdutos.setOpcoesDisponiveis(cronos20DAO);
    ...
    public void carregarLojaCliente() throws Exception {
        ...
        int cont = 0;
        int index = 0;
        for (Estabelecimento loja: cronos20DAO.getLojas()) {
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    Importador importador = new Importador(cronos20DAO);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Cronos20GUI(i_mdiFrame);
            }
