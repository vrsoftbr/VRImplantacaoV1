...
public class ASoftGUI extends VRInternalFrame {

    private static final String SISTEMA = "ASoft";
    private static final String SERVIDOR_SQL = "Firebird";
    private static ASoftGUI instance;

    private String vLojaCliente = "-1";
    private int vLojaVR = -1;

    private ASoftDAO aSoftDAO = new ASoftDAO();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new ASoftGUI(i_mdiFrame);
            }
    ...
    public ASoftGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    Importador importador = new Importador(aSoftDAO);
                    ...
                    ProgressBar.dispose();
                    Util.exibirMensagem("Importação ASoft realizada com sucesso!", getTitle());
                } catch (Exception ex) {
                    try {
                        connFirebird.close();
                    } catch (Exception ex1) {
