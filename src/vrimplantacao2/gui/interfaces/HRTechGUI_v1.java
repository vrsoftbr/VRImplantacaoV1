...
public class HRTechGUI_v1 extends VRInternalFrame {
    ...
    private HRTechGUI_v1(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();        
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new HRTechGUI_v1(i_mdiFrame);
            }
