...
public class WBAGUI extends VRInternalFrame {
    
    private static final String NOME_SISTEMA = "WBA";
    private static final String SERVIDOR_SQL = "Firebird";
    private static WBAGUI instance;
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new WBAGUI(i_mdiFrame);
            }
