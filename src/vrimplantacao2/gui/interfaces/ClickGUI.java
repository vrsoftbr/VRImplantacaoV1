...
public class ClickGUI extends VRInternalFrame implements ConexaoEvent {

    private static final String SISTEMA = "Click";
    ...
    private ClickGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new ClickGUI(i_mdiFrame);
            }
