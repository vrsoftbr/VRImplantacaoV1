...
public class InovaGUI extends VRInternalFrame {    
    
    private static final String NOME_SISTEMA = "Inova";
    private static final String SERVIDOR_SQL = "Postgres";
    private static InovaGUI instance;
    
    private final InovaDAO dao = new InovaDAO();
    ...
    private void carregarParametros() throws Exception {
        ...
        txtBancoDadosPostgres.setText(params.getWithNull("inova", NOME_SISTEMA, "DATABASE"));
        ...
        txtSenhaPostgres.setText(params.getWithNull("inova@613188#", NOME_SISTEMA, "SENHA"));
    ...
    private InovaGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new InovaGUI(i_mdiFrame);
            }
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(1, 1, 1)
                .addComponent(tab, javax.swing.GroupLayout.DEFAULT_SIZE, 252, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
