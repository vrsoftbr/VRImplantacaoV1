...
public class IntelliconGUI extends VRInternalFrame {

    private static final String NOME_SISTEMA = "Intellicon";
    private static final String SERVIDOR_FIREBIRD = "Firebird";
    private static IntelliconGUI instance;

    private IntelliconDAO intelliconDAO = new IntelliconDAO();
    ...
    private void carregarParametros() throws Exception {
        ...
        fcArquivo.setArquivo(params.getWithNull("Datashop", NOME_SISTEMA, "DATABASE"));
        txtPortaFirebird.setText(params.getWithNull("1521", NOME_SISTEMA, "PORTA"));
    ...
    private void gravarParametros() throws Exception {
        ...
        params.put(fcArquivo.getArquivo(), NOME_SISTEMA, "DATABASE");
    ...
    private IntelliconGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public void validarDadosAcessoSqlServer() throws Exception {
        if (txtHostFirebird.getText().isEmpty()) {
            throw new VRException("Favor informar host do banco de dados " + SERVIDOR_FIREBIRD);
        }
        if (fcArquivo.getArquivo().isEmpty()) {
            throw new VRException("Favor informar nome do banco de dados " + SERVIDOR_FIREBIRD);
        }

        if (txtSenhaFirebird.getText().isEmpty()) {
            throw new VRException("Favor informar a senha do banco de dados " + SERVIDOR_FIREBIRD);
        }

        if (txtUsuarioFirebird.getText().isEmpty()) {
            throw new VRException("Favor informar o usuário do banco de dados " + SERVIDOR_FIREBIRD);
        }

        connSQL.abrirConexao(txtHostFirebird.getText(), txtPortaFirebird.getInt(),
                fcArquivo.getArquivo(), txtUsuarioFirebird.getText(), txtSenhaFirebird.getText());
    ...
    public void carregarLojaCliente() throws Exception {
        ...
        int cont = 0;
        int index = 0;
        for (Estabelecimento loja : intelliconDAO.getLojas()) {
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    intelliconDAO.vBalanca = chkUsarBalanca.isSelected();
                           
                    Importador importador = new Importador(intelliconDAO);
                    ...
                    if (tab.getSelectedIndex() == 0) {
                        ...
                        if(chkOfertas.isSelected()) {
                            importador.importarOfertas(dataFimOferta.getDate());
                        }
                        ...
                        if (chkInventario.isSelected()) {
                            intelliconDAO.setDataInventario(txtDataInventario.getDate());
                        ...
                        if (chkBanco.isSelected()) {
                            importador.atualizarFornecedor(OpcaoFornecedor.BANCO_PADRAO);
                        }
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new IntelliconGUI(i_mdiFrame);
            }
    ...
    private void initComponents() {
        ...
        dataFimOferta = new org.jdesktop.swingx.JXDatePicker();
        chkCest = new vrframework.bean.checkBox.VRCheckBox();
        pnlDataInventario = new javax.swing.JPanel();
        ...
        chkBanco = new vrframework.bean.checkBox.VRCheckBox();
        ...
        chkAtivo = new vrframework.bean.checkBox.VRCheckBox();
        ...
        tabClienteVendas = new vrframework.bean.panel.VRPanel();
        ...
        fcArquivo = new vrframework.bean.fileChooser.VRFileChooser();
        ...
        pnlOferta.setBorder(javax.swing.BorderFactory.createTitledBorder("Ofertas"));

        chkOfertas.setText("Ofertas");

        dataFimOferta.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                dataFimOfertaActionPerformed(evt);
            }
        });
        ...
        pnlOfertaLayout.setHorizontalGroup(
            ...
            .addGroup(pnlOfertaLayout.createSequentialGroup()
                ...
                .addGroup(pnlOfertaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(dataFimOferta, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        pnlDataInventario.setBorder(javax.swing.BorderFactory.createTitledBorder("Inventário"));

        chkInventario.setText("Inventário");
        pnlDataInventario.add(chkInventario);
        pnlDataInventario.add(txtDataInventario);
                            ...
                            .addGroup(tabDadosLayout.createSequentialGroup()
                                .addGroup(tabDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(tabDadosLayout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(pnlDataInventario, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(22, 22, 22)
                ...
                .addGroup(tabDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(tabDadosLayout.createSequentialGroup()
                        ...
                        .addGroup(tabDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(pnlDataInventario, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                    .addGroup(tabDadosLayout.createSequentialGroup()
            ...
            .addGroup(tabFornecedorLayout.createSequentialGroup()
                ...
                .addGroup(tabFornecedorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(tabFornecedorLayout.createSequentialGroup()
                        ...
                        .addGap(62, 62, 62)
                        .addComponent(chkBanco, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        javax.swing.GroupLayout tabClienteVendasLayout = new javax.swing.GroupLayout(tabClienteVendas);
        tabClienteVendas.setLayout(tabClienteVendasLayout);
        tabClienteVendasLayout.setHorizontalGroup(
            tabClienteVendasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(tabClienteVendasLayout.createSequentialGroup()
                .addContainerGap()
        ...
        tabClienteVendasLayout.setVerticalGroup(
            tabClienteVendasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(tabClienteVendasLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(pnlDadosDataVenda, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        tabCliente.addTab("Vendas", tabClienteVendas);
        ...
        txtHostFirebird.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtHostFirebirdActionPerformed(evt);
            }
        });
                ...
                .addGroup(pnlConexaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlConexaoLayout.createSequentialGroup()
                        .addGroup(pnlConexaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtHostFirebird, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(pnlConexaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(fcArquivo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(pnlConexaoLayout.createSequentialGroup()
                        .addGroup(pnlConexaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtUsuarioFirebird, javax.swing.GroupLayout.PREFERRED_SIZE, 74, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(vRLabel4, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(pnlConexaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(vRLabel5, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtSenhaFirebird, javax.swing.GroupLayout.PREFERRED_SIZE, 79, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(pnlConexaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pnlConexaoLayout.createSequentialGroup()
                                ...
                                .addGap(0, 0, Short.MAX_VALUE))
                            .addGroup(pnlConexaoLayout.createSequentialGroup()
                                .addComponent(cmbLojaOrigem, 0, 216, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void txtHostFirebirdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtHostFirebirdActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtHostFirebirdActionPerformed
    ...
    private void dataFimOfertaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dataFimOfertaActionPerformed
       if(dataFimOferta.getDate() == null) {
           dataFimOferta.setDate(new Date());
       }
    }//GEN-LAST:event_dataFimOfertaActionPerformed
    ...
    private vrframework.bean.checkBox.VRCheckBox chkAtivo;
    private vrframework.bean.checkBox.VRCheckBox chkBanco;
    ...
    private org.jdesktop.swingx.JXDatePicker dataFimOferta;
    private org.jdesktop.swingx.JXDatePicker edtDtVendaFim;
    private org.jdesktop.swingx.JXDatePicker edtDtVendaIni;
    private vrframework.bean.fileChooser.VRFileChooser fcArquivo;
    ...
    private javax.swing.JPanel pnlDataInventario;
    ...
    private vrframework.bean.panel.VRPanel tabClienteVendas;
