...
import vrimplantacao2.dao.interfaces.MRC6DAO;
...
public class MRC6GUI extends VRInternalFrame implements ConexaoEvent {

    private static final String SISTEMA = "MRC6";
    private static MRC6GUI instance;
    ...
    private MRC6DAO dao = new MRC6DAO();
    
    private MRC6GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new MRC6GUI(i_mdiFrame);
            }
