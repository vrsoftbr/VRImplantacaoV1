...
public class SisMouraGUI extends VRInternalFrame {

    private static final String SISTEMA = "SisMoura";
    private static final String SERVIDOR_SQL = "Sql Server";
    private static SisMouraGUI instance;
    private String vLojaCliente = "-1";
    private int vLojaVR = -1;
    private SisMouraDAO sisMouraDAO = new SisMouraDAO();
    ...
    private SisMouraGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public void carregarLojaCliente() throws Exception {
        ...
        int cont = 0;
        int index = 0;
        for (Estabelecimento loja : sisMouraDAO.getLojas()) {
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new SisMouraGUI(i_mdiFrame);
            }
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    Importador importador = new Importador(sisMouraDAO);
    ...
    private void initComponents() {
        ...
        chkTelefoneForn = new vrframework.bean.checkBox.VRCheckBox();
        ...
        chkTelefoneForn.setText("Telefone");
            ...
            .addGroup(vRPanel8Layout.createSequentialGroup()
                ...
                .addGroup(vRPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(vRPanel8Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(chkTelefoneForn, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private vrframework.bean.checkBox.VRCheckBox chkTelefoneForn;
