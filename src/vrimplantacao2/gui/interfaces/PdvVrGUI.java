...
import vrimplantacao2.dao.interfaces.PdvVrDAO;
...
public class PdvVrGUI extends VRInternalFrame {
                ...
                try {
                    ...
                    if (tabs.getSelectedIndex() == 0) {
                        ...
                        if (chkDataProcessamento.isSelected()) {
                            importador.atualizarDataProcessamento();
                        }
                    }
    ...
    private void initComponents() {
        ...
        setTitle("Importação Pdv VR");
        setToolTipText("");

        vRToolBarPadrao3.setRollover(true);
        vRToolBarPadrao3.setVisibleImportar(true);
        vRToolBarPadrao3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                vRToolBarPadrao3KeyPressed(evt);
            }
        });
        ...
        chkTipoEmbalagem.setText("Tipo Embalagem Produto");
        ...
        javax.swing.GroupLayout pnlParametroLayout = new javax.swing.GroupLayout(pnlParametro);
        pnlParametro.setLayout(pnlParametroLayout);
        pnlParametroLayout.setHorizontalGroup(
            pnlParametroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pnlParametroLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(chkDataProcessamento)
                .addContainerGap(300, Short.MAX_VALUE))
        );
        pnlParametroLayout.setVerticalGroup(
            pnlParametroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pnlParametroLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(chkDataProcessamento)
        ...
        tabs.addTab("Parâmetros", pnlParametro);
        ...
        vRPanel6Layout.setVerticalGroup(
            vRPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(vRPanel6Layout.createSequentialGroup()
                .addComponent(tabsConn, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(vRPanel6, javax.swing.GroupLayout.DEFAULT_SIZE, 540, Short.MAX_VALUE))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(vRPanel6, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private javax.swing.JPanel pnlParametro;
