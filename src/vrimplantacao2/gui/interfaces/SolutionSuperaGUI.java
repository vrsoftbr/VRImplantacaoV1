...
public class SolutionSuperaGUI extends VRInternalFrame {
    
    private static final Logger LOG = Logger.getLogger(SolutionSuperaGUI.class.getName());
    
    public static final String SISTEMA = "SolutionSupera";
    private static final String SERVIDOR_SQL = "Firebird";
    private static SolutionSuperaGUI instance;
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new SolutionSuperaGUI(i_mdiFrame);
            }
    ...
    private void initComponents() {
        ...
        setTitle("Importação Solution Supera");
        setToolTipText("");
        ...
        vRTabbedPane2.addTab("Especiais", vRPanel1);
        ...
        vRLabel1.setText("Id Loja (Cliente)");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtLojaMesmoID, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tabs, javax.swing.GroupLayout.DEFAULT_SIZE, 298, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
