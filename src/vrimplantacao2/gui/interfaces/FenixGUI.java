...
public class FenixGUI extends VRInternalFrame implements ConexaoEvent {

    private static final String SISTEMA = "Fenix";
    private static FenixGUI instance;
    ...
    private FenixDAO dao = new FenixDAO();

    private FenixGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new FenixGUI(i_mdiFrame);
            }
    ...
    private void initComponents() {
        ...
        pnlLojaLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlLojaLayout.createSequentialGroup()
                ...
                .addComponent(cmbLojaVR, javax.swing.GroupLayout.DEFAULT_SIZE, 424, Short.MAX_VALUE)
