...
public class MSIInforGUI extends VRInternalFrame {
    
    private static final String SISTEMA = "MSI INFOR";
    private static final String SERVIDOR_SQL = "DBF";
    private static MSIInforGUI instance;
    ...
    private MSIInforDAO apolloDAO = new MSIInforDAO();
    private ConexaoOracle connOracle = new ConexaoOracle();
    
    private MSIInforGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new MSIInforGUI(i_mdiFrame);
            }
