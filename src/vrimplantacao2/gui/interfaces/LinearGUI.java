...
public class LinearGUI extends VRInternalFrame implements ConexaoEvent {

    private static final String SISTEMA = "Linear";
    private static LinearGUI instance;
    ...
    private LinearDAO dao = new LinearDAO();

    private LinearGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new LinearGUI(i_mdiFrame);
            }
