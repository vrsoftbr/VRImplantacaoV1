...
public class AtenasGUI extends VRInternalFrame {
    
    private static final Logger LOG = Logger.getLogger(AtenasGUI.class.getName());
    
    public static final String SISTEMA = "Atenas";
    private static final String SERVIDOR_SQL = "Firebird";
    private static AtenasGUI instance;
    
    private String vLojaCliente = "-1";
    private int vLojaVR = -1;
    
    private AtenasDAO dao = new AtenasDAO();
    
    private AtenasGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();     
    ...
    private void gravarParametros() throws Exception {
        ...
        params.put("FIREBIRD", SISTEMA, "CONEXAO");
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new AtenasGUI(i_mdiFrame);
            }
