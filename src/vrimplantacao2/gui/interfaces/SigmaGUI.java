...
public class SigmaGUI extends VRInternalFrame {
    ...
    private static final String SISTEMA = "Sigma";
    private static final String SERVIDOR_SQL = "Firebird";
    private static SigmaGUI instance;
    ...
    private void carregarParametros() throws Exception {
        ...
        txtDatabase.setArquivo(params.getWithNull("C:\\Sigma\\Bancos\\SISTEMA.FDB", SISTEMA, "DATABASE"));
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new SigmaGUI(i_mdiFrame);
            }
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtDatabase, javax.swing.GroupLayout.DEFAULT_SIZE, 387, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(vRPanel6, javax.swing.GroupLayout.DEFAULT_SIZE, 721, Short.MAX_VALUE))
                .addContainerGap())
        );
