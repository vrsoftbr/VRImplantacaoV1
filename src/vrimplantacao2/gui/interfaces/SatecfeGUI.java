...
public class SatecfeGUI extends VRInternalFrame {

    private static final String SISTEMA = "Satecfe";
    private static final String SERVIDOR_SQL = "MySql";
    private static SatecfeGUI instance;
    private SatecfeDAO satecfeDAO = new SatecfeDAO();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new SatecfeGUI(i_mdiFrame);
            }
    ...
    public SatecfeGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    /*public void carregarLojaCliente() throws Exception {
        ...
        int cont = 0;
        int index = 0;
        for (Estabelecimento loja: satecfeDAO.getLojasCliente()) {
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    idLojaCliente = edtLojaOrigem.getText();                        
                    Importador importador = new Importador(satecfeDAO);
    ...
    private void initComponents() {
        ...
        edtLojaOrigem = new vrframework.bean.textField.VRTextField();
                ...
                .addGroup(vRPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(vRPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(vRPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(edtLojaOrigem, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        vRPanel1Layout.setVerticalGroup(
            ...
            .addGroup(vRPanel1Layout.createSequentialGroup()
                ...
                .addGroup(vRPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(edtLojaOrigem, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
        );
    ...
    private vrframework.bean.textField.VRTextField edtLojaOrigem;
