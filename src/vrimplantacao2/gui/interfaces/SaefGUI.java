                ...
                try {
                    ...
                    if (tabs.getSelectedIndex() == 0) {
                        ...
                        if (chkPdvVendas.isSelected()) {
                            ...
                            //saefDAO.setDataInicioVenda(vendaDataInicio);
                            //saefDAO.setDataTerminoVenda(vendaDataFim);
                            saefDAO.setDataInicioVenda(edtDtVendaIni.getDate());
                            saefDAO.setDataTerminoVenda(edtDtVendaFim.getDate());
