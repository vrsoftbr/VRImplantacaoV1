...
public class ApolloGUI extends VRInternalFrame {
    
    private static final String SISTEMA = "APOLLO";
    private static final String SERVIDOR_SQL = "Oracle";
    private static ApolloGUI instance;
    ...
    private void carregarParametros() throws Exception {
        ...
        txtSchema.setText(params.get(SISTEMA, "SCHEMA"));
    ...
    private void gravarParametros() throws Exception {
        ...
        params.put(txtSchema.getText(), SISTEMA, "SCHEMA");
    ...
    private ApolloDAO apolloDAO = new ApolloDAO();
    private ConexaoOracle connOracle = new ConexaoOracle();
    
    private ApolloGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public void carregarLojaCliente() throws Exception {
        apolloDAO.setSchema(txtSchema.getText());
        cmbLojaOrigem.setModel(new DefaultComboBoxModel());
        int cont = 0;
        int index = 0;
        for (Estabelecimento loja: apolloDAO.getLojasCliente()) {
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new ApolloGUI(i_mdiFrame);
            }
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    Importador importador = new Importador(apolloDAO);
    ...
    private void initComponents() {
        ...
        chkManterEans = new vrframework.bean.checkBox.VRCheckBox();
        ...
        chkManterEans.setText("Manter EAN");
        chkManterEans.setEnabled(true);
                    ...
                    .addGroup(vRPanel7Layout.createSequentialGroup()
                        .addGroup(vRPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(vRPanel7Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(chkManterEans, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        financeiroImportView.setOpcoes(OpcaoRecebimentoCaixa.NOVOS,
            OpcaoRecebimentoCaixa.TODOS
        );
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtDatabase, javax.swing.GroupLayout.PREFERRED_SIZE, 68, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtStrConexao, javax.swing.GroupLayout.DEFAULT_SIZE, 365, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        vRLabel22.setText("Schema");

        txtSchema.setText("SINHAINTER");
        txtSchema.setCaixaAlta(false);
                ...
                .addGroup(vRPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(vRPanel6Layout.createSequentialGroup()
                        ...
                        .addGroup(vRPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtSenha, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(vRPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(vRPanel6, javax.swing.GroupLayout.DEFAULT_SIZE, 515, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
    ...
    private vrframework.bean.checkBox.VRCheckBox chkManterEans;
    ...
    private vrimplantacao2.gui.component.importpanel.financeiro.FinanceiroImportView financeiroImportView;
