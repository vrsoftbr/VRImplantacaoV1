...
public class InterDataGUI extends VRInternalFrame {

    private static final String NOME_SISTEMA = "InterData";
    private static final String SERVIDOR_SQL = "Firebird";
    private static InterDataGUI instance;

    private final InterDataDAO dao = new InterDataDAO();
    ...
    private void carregarParametros() throws Exception {
        ...
        txtSenhaFirebird.setText(params.getWithNull("19621017", NOME_SISTEMA, "SENHA"));
    ...
    private InterDataGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new InterDataGUI(i_mdiFrame);
            }
