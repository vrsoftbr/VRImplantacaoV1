...
public class GuiaSistemasGUI extends VRInternalFrame {
    ...
    private static final String NOME_SISTEMA = "GuiaSistemas";
    private static final String SERVIDOR_SQL = "SQL Server";
    private static GuiaSistemasGUI instance;
    ...
    private GuiaSistemasGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new GuiaSistemasGUI(i_mdiFrame);
            }
