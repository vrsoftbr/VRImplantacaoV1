...
public class CefasGUI extends VRInternalFrame {
    
    private static final String SISTEMA = "CEFAS";
    private static final String SERVIDOR_SQL = "Oracle";
    private static CefasGUI instance;
    ...
    private void gravarParametros() throws Exception {
        ...
        PlanoContasVO planoContaCR = (PlanoContasVO) cmbPlanoContaCR.getSelectedItem();
        if(planoContaCR != null) {
            params.put(planoContaCR.vid, SISTEMA, "PLANO_CONTAS_CREDITOR_ROTATIVO");
            vPlanoContas = planoContaCR.vid;
        }
        params.salvar();
    }
    
    private CefasDAO cefasDAO = new CefasDAO();
    private ConexaoOracle connOracle = new ConexaoOracle();
    
    private CefasGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        carregarParametros();
        btnMapaTributacao.setProvider(new MapaTributacaoButtonProvider() {
            @Override
    ...
    public void carregarLojaCliente() throws Exception {
        ...
        int cont = 0;
        int index = 0;
        for (Estabelecimento loja: cefasDAO.getLojasCliente()) {
    ...
    public void carregarPlanoContasCreditoRotativo() throws Exception {
        ...
        int cont = 0;
        int index = 0;
        for(PlanoContasVO plano : cefasDAO.getPlanoContas()) {
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new CefasGUI(i_mdiFrame);
            }
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    cefasDAO.vPlanoContas = ((PlanoContasVO) cmbPlanoContaCR.getSelectedItem()).vid;
                    cefasDAO.vBalanca = chkTemBalanca.isSelected();
                    
                    Importador importador = new Importador(cefasDAO);
                    ...
                    if (tabs.getSelectedIndex() == 0) {
                        ...
                        if(chkPdvVendas.isSelected()) {
                            cefasDAO.setDataInicioVenda(edtDtVendaIni.getDate());
                            cefasDAO.setDataTerminoVenda(edtDtVendaFim.getDate());
    ...
    private void initComponents() {
        ...
        chkFornFabr = new vrframework.bean.checkBox.VRCheckBox();
        btnMapaTributacao = new vrimplantacao2.gui.component.mapatributacao.mapatributacaobutton.MapaTributacaoButton();
        ...
        chkFornFabr.setText("Fabricante");
                    ...
                    .addGroup(vRPanel7Layout.createSequentialGroup()
                        ...
                        .addGroup(vRPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(vRPanel7Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(chkFornFabr, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addComponent(btnMapaTributacao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        vRPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(vRPanel9Layout.createSequentialGroup()
                ...
                .addGroup(vRPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(cmbPlanoContaCR, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        vRTabbedPane2.addTab("Vendas", vRPanel1);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(vRImportaArquivBalancaPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private vrimplantacao2.gui.component.mapatributacao.mapatributacaobutton.MapaTributacaoButton btnMapaTributacao;
    ...
    private vrframework.bean.checkBox.VRCheckBox chkFornFabr;
