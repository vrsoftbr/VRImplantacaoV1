package vrimplantacao2.gui.interfaces.unificacao.primeiropreco;
...
public class PrimeiroPrecoGUI extends VRInternalFrame {
    
    private static final String SISTEMA = "Primeiro Preco";
    private static final String SERVIDOR_SQL = "Postgres";
    private static PrimeiroPrecoGUI instance;
    ...
    private PrimeiroPrecoDAO dao = new PrimeiroPrecoDAO();
    
    private PrimeiroPrecoGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new PrimeiroPrecoGUI(i_mdiFrame);
            }
    ...
    private void initComponents() {
        ...
        getAccessibleContext().setAccessibleName("Unificação Primeiro Preço");
