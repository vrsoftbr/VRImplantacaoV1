...
public class SabTechGUI extends VRInternalFrame implements ConexaoEvent {

    private static final String SISTEMA = "SabTech";
    private static SabTechGUI instance;
    ...
    private SabTechDAO dao = new SabTechDAO();

    private SabTechGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new SabTechGUI(i_mdiFrame);
            }
            ...
            public void run() {
                try {
                    ...
                    if (tabOperacoes.getSelectedIndex() == 0) {
                        ...
                        if (chkSexoCliente.isSelected()) {
                            opt.add(OpcaoCliente.SEXO);
                        }
                        if (!opt.isEmpty()) {
    ...
    private void initComponents() {
        ...
        chkSexoCliente = new vrframework.bean.checkBox.VRCheckBox();
            ...
            .addGroup(tabClientesLayout.createSequentialGroup()
                ...
                .addGroup(tabClientesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(tabClientesLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(chkSexoCliente, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private vrframework.bean.checkBox.VRCheckBox chkSexoCliente;
