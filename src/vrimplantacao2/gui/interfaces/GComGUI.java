...
public class GComGUI extends VRInternalFrame {

    private static final String NOME_SISTEMA = "GCom";
    private static final String SERVIDOR_SQL = "Firebird";
    private static GComGUI instance;

    private final GComDAO dao = new GComDAO();
    ...
    private GComGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new GComGUI(i_mdiFrame);
            }
            ...
            .addGroup(pnlConexaoLayout.createSequentialGroup()
                ...
                .addGroup(pnlConexaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlConexaoLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(pnlConexaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtBancoDadosFirebird, javax.swing.GroupLayout.DEFAULT_SIZE, 276, Short.MAX_VALUE)
                            .addGroup(pnlConexaoLayout.createSequentialGroup()
