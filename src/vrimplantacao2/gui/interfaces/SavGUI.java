...
public class SavGUI extends VRInternalFrame implements ConexaoEvent {

    private static final String SISTEMA = "Sav";
    private static SavGUI instance;
    ...
    private SavDAO dao = new SavDAO();

    private SavGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new SavGUI(i_mdiFrame);
            }
