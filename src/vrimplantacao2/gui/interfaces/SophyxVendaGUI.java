...
public class SophyxVendaGUI extends VRInternalFrame {

    private static final String NOME_SISTEMA = "Sophyx";
    private static final String SERVIDOR_SQL = "SQLite";
    private static SophyxVendaGUI instance;

    private final SophyxDAO dao = new SophyxDAO();
    private ConexaoSQLite connSQL = null;
    ...
    private SophyxVendaGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public void validarDadosAcessoPostgres() throws Exception {
        ...
        connSQL = new ConexaoSQLite(txtBancoDadosFirebird.getArquivo());
        connSQL.conectar();
    ...
    public void carregarLojaCliente() throws Exception {
        ...
        int cont = 0;
        int index = 0;
        for (Estabelecimento loja : dao.getLojaClienteSQLite()) {
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new SophyxVendaGUI(i_mdiFrame);
            }
            ...
            .addGroup(pnlConexaoLayout.createSequentialGroup()
                ...
                .addGroup(pnlConexaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlConexaoLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(pnlConexaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtBancoDadosFirebird, javax.swing.GroupLayout.DEFAULT_SIZE, 194, Short.MAX_VALUE)
                            .addGroup(pnlConexaoLayout.createSequentialGroup()
