...
public class HerculesIntCashGUI extends VRInternalFrame implements ConexaoEvent {

    private static final String SISTEMA = "HerculesIntCash";
    private static HerculesIntCashGUI instance;
    ...
    private HerculesIntCashDAO dao = new HerculesIntCashDAO();

    private HerculesIntCashGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        conexao.database = "HYUAQUQRNJFB84Z1996M";
        conexao.port = "1433";
        conexao.user = "sa";
        conexao.pass = "integralgc";
    ...
    public void carregarLojaCliente() throws Exception {
        ...
        int cont = 0;
        int index = 0;
        for (Filial loja : dao.getLojasCliente()) {
            cmbLojaOrigem.addItem(loja);
            if (vLojaCliente != null && vLojaCliente.equals(loja.getKey())) {
                index = cont;
            }
            cont++;
        }
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new HerculesIntCashGUI(i_mdiFrame);
            }
    ...
    private void initComponents() {
        ...
        setTitle("Importação Hercules");
        setToolTipText("");

        conexao.setSistema("JM2Online");

        vRLabel3.setText("Compl.");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(conexao, javax.swing.GroupLayout.DEFAULT_SIZE, 536, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(vRLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tabOperacoes, javax.swing.GroupLayout.DEFAULT_SIZE, 344, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
