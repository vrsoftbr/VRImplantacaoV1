...
public class TopSystemGUI3 extends VRInternalFrame implements ConexaoEvent {

    private static final String SISTEMA = "TopSystem";
    private static TopSystemGUI3 instance;
    ...
    private TopSystemGUI3(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new TopSystemGUI3(i_mdiFrame);
            }
