 ...
 * @author Guilherme
 */
public class ControlePlusPostgresGUI extends VRInternalFrame {

    private static final String SISTEMA = "ControlePlus";

    private static ControlePlusPostgresGUI instance;

    private String vLojaCliente;
    private int vLojaVR;
    private final ControlePlusPostgresDAO dao;

    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            i_mdiFrame.setWaitCursor();
            if (instance == null || instance.isClosed()) {
                instance = new ControlePlusPostgresGUI(i_mdiFrame);
            }
     ...
     */
    public ControlePlusPostgresGUI(VRMdiFrame frame) throws Exception {
        super(frame);
        this.dao = new ControlePlusPostgresDAO();
        initComponents();
    ...
    private void initComponents() {
        ...
        tabImpFornecedorLayout.setVerticalGroup(
            tabImpFornecedorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(tabFornecedor, javax.swing.GroupLayout.DEFAULT_SIZE, 290, Short.MAX_VALUE)
        );
