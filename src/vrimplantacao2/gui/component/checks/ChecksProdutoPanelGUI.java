...
import vrimplantacao2.gui.component.mapareformatributaria.classificacaotributariancm.MapaReformaTributariaClassificacaoNcmView;
...
//        this.importador.checarVendasDataAtual = chkVerificarVendadDeHoje.isSelected();
    ...
    public void setOpcoesDisponiveis(InterfaceDAO dao) {
        ...
        if (opt.contains(OpcaoProduto.DESC_COMPLETA)
                ...
                || opt.contains(OpcaoProduto.TIPO_COMPRA)) {
            ...
            chkTipoCompra.setVisible(opt.contains(OpcaoProduto.TIPO_COMPRA));
            chkEcomerce.setVisible(opt.contains(OpcaoProduto.PRODUTO_ECOMMERCE));
            chkConferido.setVisible(opt.contains(OpcaoProduto.CONFERIDO));
            chkAssociado.setVisible(opt.contains(OpcaoProduto.ASSOCIADO));
            chkMultiplicaPdv.setVisible(opt.contains(OpcaoProduto.ACEITA_MULTIPLICACAO_PDV));
            chkPermiteQuebra.setVisible(opt.contains(OpcaoProduto.PERMITE_QUEBRA));
            chkPermitePerda.setVisible(opt.contains(OpcaoProduto.PERMITE_PERDA));
            chkPermiteTroca.setVisible(opt.contains(OpcaoProduto.PERMITE_TROCA));
            chkSazonal.setVisible(opt.contains(OpcaoProduto.SAZONAL));
            chkPermiteDescontoPdv.setVisible(opt.contains(OpcaoProduto.PERMITE_DESCONTO_PDV));
            chkVerificaPesoPdv.setVisible(opt.contains(OpcaoProduto.VERIFICA_PESO_PDV));
...
//        }
    ...
    private void initComponents() {
        ...
        chkManterCodigoMercadologico = new vrframework.bean.checkBox.VRCheckBox();
        ...
        btnClassificacaoTributariaNcm = new javax.swing.JButton();
        ...
        chkProdutosBalanca = new vrframework.bean.checkBox.VRCheckBox();
        ...
        chkMargemMaxima = new vrframework.bean.checkBox.VRCheckBox();
        ...
        chkIcmsLoja = new vrframework.bean.checkBox.VRCheckBox();
        ...
        chkTipoCompra = new vrframework.bean.checkBox.VRCheckBox();
        chkEcomerce = new vrframework.bean.checkBox.VRCheckBox();
        chkConferido = new vrframework.bean.checkBox.VRCheckBox();
        chkMultiplicaPdv = new vrframework.bean.checkBox.VRCheckBox();
        chkPermiteQuebra = new vrframework.bean.checkBox.VRCheckBox();
        chkPermitePerda = new vrframework.bean.checkBox.VRCheckBox();
        chkPermiteTroca = new vrframework.bean.checkBox.VRCheckBox();
        chkSazonal = new vrframework.bean.checkBox.VRCheckBox();
        chkPermiteDescontoPdv = new vrframework.bean.checkBox.VRCheckBox();
        chkVerificaPesoPdv = new vrframework.bean.checkBox.VRCheckBox();
        ...
        chkSimilar = new vrframework.bean.checkBox.VRCheckBox();
        chkKit = new vrframework.bean.checkBox.VRCheckBox();
        ...
        org.openide.awt.Mnemonics.setLocalizedText(chkManterCodigoMercadologico, "Manter Código Mercadológico");
        ...
        pnlOptAssociadoLayout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {chkInverterAssociado, jLabel2});
        ...
        org.openide.awt.Mnemonics.setLocalizedText(btnClassificacaoTributariaNcm, "Classificação Tributária - NCM");
        btnClassificacaoTributariaNcm.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnClassificacaoTributariaNcmActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnClassificacaoTributariaNcm, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(btnClassificacaoTributariaNcm)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        org.openide.awt.Mnemonics.setLocalizedText(chkProdutosBalanca, "Produtos Balança");
            ...
            .addGroup(pnlImpProdutoLayout.createSequentialGroup()
                ...
                .addGroup(pnlImpProdutoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlImpProdutoLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(chkProdutosBalanca, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        org.openide.awt.Mnemonics.setLocalizedText(chkMargemMaxima, "Margem Máxima");
            ...
            .addGroup(pnlImpComplLayout.createSequentialGroup()
                ...
                .addGroup(pnlImpComplLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlImpComplLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(chkMargemMaxima, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            .addGroup(pnlImpComplLayout.createSequentialGroup()
                ...
                .addGroup(pnlImpComplLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlImpComplLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(chkMargemMaxima, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(5, 5, 5)
                .addGroup(pnlImpComplLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(chkEstoqueMaximo, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(pnlImpComplLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(chkNormaReposicao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(chkSecao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(chkPrateleira, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(chkTeclaAssociada, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(pnlImpComplLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(chkTipoProduto, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(chkEstoqueMinimo, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
        ...
        org.openide.awt.Mnemonics.setLocalizedText(chkIcmsLoja, "ICMS Loja");
            ...
            .addGroup(pnlImpTributacaoLayout.createSequentialGroup()
                .addGroup(pnlImpTributacaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlImpTributacaoLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlImpTributacaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pnlImpTributacaoLayout.createSequentialGroup()
                                .addComponent(chkIcmsLoja, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        org.openide.awt.Mnemonics.setLocalizedText(chkTipoCompra, "Tipo Compra");

        org.openide.awt.Mnemonics.setLocalizedText(chkEcomerce, "Venda-Ecomerce");

        org.openide.awt.Mnemonics.setLocalizedText(chkConferido, "Conferido");

        org.openide.awt.Mnemonics.setLocalizedText(chkMultiplicaPdv, "Multiplica PDV");

        org.openide.awt.Mnemonics.setLocalizedText(chkPermiteQuebra, "Permite Quebra");

        org.openide.awt.Mnemonics.setLocalizedText(chkPermitePerda, "Permite Perda");

        org.openide.awt.Mnemonics.setLocalizedText(chkPermiteTroca, "Permite Troca");

        org.openide.awt.Mnemonics.setLocalizedText(chkSazonal, "Sazonal");
        chkSazonal.setToolTipText("");

        org.openide.awt.Mnemonics.setLocalizedText(chkPermiteDescontoPdv, "Permite Desconto PDV");
        chkPermiteDescontoPdv.setToolTipText("");

        org.openide.awt.Mnemonics.setLocalizedText(chkVerificaPesoPdv, "Verifica Peso PDV");
        chkVerificaPesoPdv.setToolTipText("");

        org.openide.awt.Mnemonics.setLocalizedText(chkPromocaoAuditada, "Promoção Auditada");
        chkPromocaoAuditada.setToolTipText("");

        org.openide.awt.Mnemonics.setLocalizedText(chkProdutoAssessorado, "Produto Assessorado");
        chkProdutoAssessorado.setToolTipText("");
                    ...
                    .addGroup(pnlImpInfoAdicLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlImpInfoAdicLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pnlImpInfoAdicLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(chkMultiplicaPdv, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(chkPermiteQuebra, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(chkPermitePerda, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(chkPermiteTroca, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(pnlImpInfoAdicLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(chkPermiteDescontoPdv, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(pnlImpInfoAdicLayout.createSequentialGroup()
                        .addContainerGap()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(chkVerificaPesoPdv, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(pnlImpInfoAdicLayout.createSequentialGroup()
                        .addContainerGap()
                        .addGroup(pnlImpInfoAdicLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, pnlImpInfoAdicLayout.createSequentialGroup()
                                .addComponent(chkEcomerce, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, pnlImpInfoAdicLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(chkTipoCompra, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(chkPromocaoAuditada, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(chkProdutoAssessorado, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addGap(120, 282, Short.MAX_VALUE))
        );
        ...
        org.openide.awt.Mnemonics.setLocalizedText(chkSimilar, "Produto Similar");

        org.openide.awt.Mnemonics.setLocalizedText(chkKit, "Kits");
                        ...
                        .addGroup(pnlImpOutrosDadosLayout.createSequentialGroup()
                            .addGroup(pnlImpOutrosDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(pnlImpOutrosDadosLayout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(chkSimilar, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(chkKit, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(pnlImpOutrosDadosLayout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(chkNumeroParcela, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                    .addGroup(pnlImpOutrosDadosLayout.createSequentialGroup()
    ...
    private void btnClassificacaoTributariaNcmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClassificacaoTributariaNcmActionPerformed

        try {
            MapaReformaTributariaClassificacaoNcmView.exibir(
                    reformaTributariaProvider.getFrame(),
                    reformaTributariaProvider.getSistema(),
                    reformaTributariaProvider.getLoja(),
                    reformaTributariaProvider.getProvider(),
                    reformaTributariaProvider.getLojaVR()
            );
        } catch (Exception ex) {
            System.out.println("Erro ao abrir o MAPA de Reforma Tributária NCM");
        }
    }//GEN-LAST:event_btnClassificacaoTributariaNcmActionPerformed

    // Variables declaration - do not modify//GEN-BEGIN:variables
    public javax.swing.ButtonGroup btgPautaFiscal;
    public javax.swing.JButton btnClassificacaoTributaria;
    public javax.swing.JButton btnClassificacaoTributariaNcm;
    ...
    public vrframework.bean.checkBox.VRCheckBox chkEcomerce;
    ...
    public vrframework.bean.checkBox.VRCheckBox chkIcmsLoja;
    public vrframework.bean.checkBox.VRCheckBox chkImportarSomenteProdutosAtivos;
    ...
    public vrframework.bean.checkBox.VRCheckBox chkKit;
    ...
    public vrframework.bean.checkBox.VRCheckBox chkMargemMaxima;
    ...
    public vrframework.bean.checkBox.VRCheckBox chkMultiplicaPdv;
    ...
    public vrframework.bean.checkBox.VRCheckBox chkPermiteDescontoPdv;
    public vrframework.bean.checkBox.VRCheckBox chkPermitePerda;
    public vrframework.bean.checkBox.VRCheckBox chkPermiteQuebra;
    public vrframework.bean.checkBox.VRCheckBox chkPermiteTroca;
    ...
    public vrframework.bean.checkBox.VRCheckBox chkProdutoAssessorado;
    ...
    public vrframework.bean.checkBox.VRCheckBox chkPromocaoAuditada;
    ...
    public vrframework.bean.checkBox.VRCheckBox chkSazonal;
    public vrframework.bean.checkBox.VRCheckBox chkSecao;
    public vrframework.bean.checkBox.VRCheckBox chkSimilar;
    ...
    public vrframework.bean.checkBox.VRCheckBox chkTeclaAssociada;
    public vrframework.bean.checkBox.VRCheckBox chkTipoCompra;
    ...
    public vrframework.bean.checkBox.VRCheckBox chkVerificaPesoPdv;
    ...
    public class ProdutoPanelImportador {
        ...
        public void importar() throws Exception {
...

            {
                ...
                if (chkForcarPrecoCusto.isSelected()) {
                ...
                if (chkTeclaAssociada.isSelected()) {
                    opcoes.add(OpcaoProduto.TECLA_ASSOCIADA);
                }
                ...
                if (chkMargemMaxima.isSelected()) {
                    opcoes.add(OpcaoProduto.MARGEM_MAXIMA);
                }
                ...
                if (chkSugestaoPedido.isSelected()) {
                    opcoes.add(OpcaoProduto.SUGESTAO_PEDIDO);
                }
                ...
                if (chkTipoCompra.isSelected()) {
                    opcoes.add(OpcaoProduto.TIPO_COMPRA);
                }
                if (chkEcomerce.isSelected()) {
                    opcoes.add(OpcaoProduto.PRODUTO_ECOMMERCE);
                }
                if (chkConferido.isSelected()) {
                    opcoes.add(OpcaoProduto.CONFERIDO);
                }
                if (chkPermiteQuebra.isSelected()) {
                    opcoes.add(OpcaoProduto.PERMITE_QUEBRA);
                }
                if (chkPermitePerda.isSelected()) {
                    opcoes.add(OpcaoProduto.PERMITE_PERDA);
                }
                if (chkPermiteTroca.isSelected()) {
                    opcoes.add(OpcaoProduto.PERMITE_TROCA);
                }
                if (chkSazonal.isSelected()) {
                    opcoes.add(OpcaoProduto.SAZONAL);
                }
                if (chkPermiteDescontoPdv.isSelected()) {
                    opcoes.add(OpcaoProduto.PERMITE_DESCONTO_PDV);
                }
                if (chkVerificaPesoPdv.isSelected()) {
                    opcoes.add(OpcaoProduto.VERIFICA_PESO_PDV);
                }
                if (chkPromocaoAuditada.isSelected()) {
                    opcoes.add(OpcaoProduto.PROMOCAO_AUDITADA);
                }
                if (chkProdutoAssessorado.isSelected()) {
                    opcoes.add(OpcaoProduto.PRODUTO_ASSESSORADO);
                }
            ...
            if (chkSimilar.isSelected()) {
                ...
                importador.importarProdutoSimilar();
            }

            if (chkKit.isSelected()) {

                importador.importarKit();
            }
