 ...
 * @author Guilherme
 */
public class SuperControle_PostgresGUI extends VRInternalFrame {

    private static final String SISTEMA = "SuperControle";

    private static SuperControle_PostgresGUI instance;
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new SuperControle_PostgresGUI(i_mdiFrame);
            }
