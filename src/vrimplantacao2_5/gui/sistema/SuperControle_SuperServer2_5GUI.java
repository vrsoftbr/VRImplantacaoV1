...
public class SuperControle_SuperServer2_5GUI extends VRInternalFrame {
    ...
    public SuperControle_SuperServer2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new SuperControle_SuperServer2_5GUI(i_mdiFrame);
            }
    ...
    private void initComponents() {
        ...
        setTitle("Super Controle Super Server");
        setToolTipText("");
