...
public class Mbd2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.MBD.getNome();
    private static Mbd2_5GUI instance;

    private final MbdDAO dao = new MbdDAO();
    ...
    public Mbd2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.MBD);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Mbd2_5GUI(i_mdiFrame);
            }
