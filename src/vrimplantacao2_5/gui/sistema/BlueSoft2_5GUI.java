...
import vrimplantacao2_5.dao.sistema.BlueSoftDAO;
import vrimplantacao2_5.vo.enums.ESistema;

public class BlueSoft2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.BLUESOFT.getNome();
    private static BlueSoft2_5GUI instance;

    private final BlueSoftDAO dao = new BlueSoftDAO();
    ...
    public BlueSoft2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.DSIC);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new BlueSoft2_5GUI(i_mdiFrame);
            }
