...
public class Target_G32_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.TARGET_G3.getNome();
    private static Target_G32_5GUI instance;

    private final Target_G3DAO dao = new Target_G3DAO();
    ...
    public Target_G32_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.TARGET_G3);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Target_G32_5GUI(i_mdiFrame);
            }
