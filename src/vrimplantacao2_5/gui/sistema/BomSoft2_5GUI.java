...
public class BomSoft2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.BOMSOFT.getNome();
    private static BomSoft2_5GUI instance;
    ...
    public BomSoft2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.BOMSOFT);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new BomSoft2_5GUI(i_mdiFrame);
            }
