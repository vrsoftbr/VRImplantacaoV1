...
import vrimplantacao2_5.dao.sistema.MobilityDAO;
import vrimplantacao2_5.vo.enums.ESistema;

public class Mobility2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.MOBILITY.getNome();
    private static Mobility2_5GUI instance;
    ...
    public Mobility2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.MOBILITY);
            ...
            public void run() {
                try {
                    ...
                    if (tabProdutos.edtDtVendaIni.getDate() != null) {
                        dao.setVendaDataInicio(tabProdutos.edtDtVendaIni.getDate());
                    }
                    if (tabProdutos.edtDtVendaFim.getDate() != null) {
                        dao.setVendaDataTermino(tabProdutos.edtDtVendaFim.getDate());
                    }
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Mobility2_5GUI(i_mdiFrame);
            }
