...
public class CadastraFacil2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.CADASTRAFACIL.getNome();
    private static CadastraFacil2_5GUI instance;

    private final CadastraFacil2_5DAO dao = new CadastraFacil2_5DAO();
    ...
    public CadastraFacil2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.CADASTRAFACIL);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new CadastraFacil2_5GUI(i_mdiFrame);
            }
