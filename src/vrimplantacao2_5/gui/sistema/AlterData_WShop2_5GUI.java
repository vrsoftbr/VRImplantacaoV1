 ...
 * @author Guilherme
 */
public class AlterData_WShop2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.ALTERDATAWSHOP.getNome();

    private static AlterData_WShop2_5GUI instance;
    private final AlterData_WShopDAO dao;

    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            i_mdiFrame.setWaitCursor();
            if (instance == null || instance.isClosed()) {
                instance = new AlterData_WShop2_5GUI(i_mdiFrame);
            }
     ...
     */
    public AlterData_WShop2_5GUI(VRMdiFrame frame) throws Exception {
        super(frame);
        this.dao = new AlterData_WShopDAO();
        initComponents();
        ...
        pnlConn.setSistema(ESistema.ALTERDATAWSHOP);
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Importação Alter Data WShop");
