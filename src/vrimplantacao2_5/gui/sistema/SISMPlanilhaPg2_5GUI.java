...
import vrimplantacao2_5.dao.sistema.SISMPlanilhaPgDAO;
...
public class SISMPlanilhaPg2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.SISMPLANILHAPG.getNome();
    private static SISMPlanilhaPg2_5GUI instance;
    private String vLojaCliente = "-1";
    private int vLojaVR = -1;
    private final SISMPlanilhaPgDAO dao = new SISMPlanilhaPgDAO();
    ...
    public SISMPlanilhaPg2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.GZPRODADOS);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new SISMPlanilhaPg2_5GUI(i_mdiFrame);
            }
    ...
    private void initComponents() {
        ...
        setTitle("Importação GZProdados");
        setToolTipText("");
