...
public class MegaSoftware2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.MEGASOFTWARE.getNome();
    private static MegaSoftware2_5GUI instance;

    private final MegaSoftwareDAO dao = new MegaSoftwareDAO();
    ...
    public MegaSoftware2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.MEGASOFTWARE);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new MegaSoftware2_5GUI(i_mdiFrame);
            }
