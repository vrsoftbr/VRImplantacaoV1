...
public class Pallas2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.PALLAS.getNome();
    private static Pallas2_5GUI instance;
    private String vLojaCliente = "-1";
    private int vLojaVR = -1;
    private final PallasDAO dao = new PallasDAO();
    ...
    public Pallas2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.PALLAS);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Pallas2_5GUI(i_mdiFrame);
            }
