...
public class SoftLog2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.SOFTLOG.getNome();
    private static SoftLog2_5GUI instance;

    private final SoftLogDAO dao = new SoftLogDAO();
    ...
    public SoftLog2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.SOFTLOG);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new SoftLog2_5GUI(i_mdiFrame);
            }
