...
public class SaurusPDV2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.SAURUSPDV.getNome();
    private static SaurusPDV2_5GUI instance;

    private final SaurusPDVDAO dao = new SaurusPDVDAO();
    ...
    public SaurusPDV2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.SAURUSPDV);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new SaurusPDV2_5GUI(i_mdiFrame);
            }
