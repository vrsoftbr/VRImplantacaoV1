...
import vrimplantacao2_5.dao.sistema.Lince2_5DAO;
import vrimplantacao2_5.vo.enums.ESistema;

public class Lince2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.LINCE.getNome();
    private static Lince2_5GUI instance;

    private final Lince2_5DAO dao = new Lince2_5DAO();
    ...
    public Lince2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.LINCE);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Lince2_5GUI(i_mdiFrame);
            }
