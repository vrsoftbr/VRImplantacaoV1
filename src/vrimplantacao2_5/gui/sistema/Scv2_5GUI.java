...
public class Scv2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.SCV.getNome();
    private static Scv2_5GUI instance;

    private final ScvDAO dao = new ScvDAO();
    ...
    public Scv2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Scv2_5GUI(i_mdiFrame);
            }
