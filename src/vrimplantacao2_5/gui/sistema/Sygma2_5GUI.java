...
public class Sygma2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.SYGMA.getNome();
    private static Sygma2_5GUI instance;

    private final SygmaDAO dao = new SygmaDAO();
    ...
    public Sygma2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Sygma2_5GUI(i_mdiFrame);
            }
