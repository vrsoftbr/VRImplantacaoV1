...
public class CenterInformatica2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.CENTER_INFORMATICA.getNome();
    private static CenterInformatica2_5GUI instance;

    private final CenterInformaticaDAO2_5 dao = new CenterInformaticaDAO2_5();
    ...
    public CenterInformatica2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.CENTER_INFORMATICA);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new CenterInformatica2_5GUI(i_mdiFrame);
            }
