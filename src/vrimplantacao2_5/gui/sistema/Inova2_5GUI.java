...
public class Inova2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.INOVA.getNome();
    private static Inova2_5GUI instance;
    ...
    public Inova2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.INOVA);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Inova2_5GUI(i_mdiFrame);
            }
