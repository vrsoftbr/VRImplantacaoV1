...
public class AlphaSys2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.ALPHASYS.getNome();
    private static AlphaSys2_5GUI instance;

    private final AlphaSys2_5DAO dao = new AlphaSys2_5DAO();
    ...
    public AlphaSys2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.ALPHASYS);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new AlphaSys2_5GUI(i_mdiFrame);
            }
