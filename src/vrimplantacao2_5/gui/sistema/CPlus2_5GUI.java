...
public class CPlus2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.CPLUS.getNome();
    private static CPlus2_5GUI instance;

    private final CPlus2_5DAO dao = new CPlus2_5DAO();
    ...
    public CPlus2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.CPLUS);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new CPlus2_5GUI(i_mdiFrame);
            }
