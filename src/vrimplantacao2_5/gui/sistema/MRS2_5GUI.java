...
public class MRS2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.MRS.getNome();
    private static MRS2_5GUI instance;

    private final MrsDAO dao = new MrsDAO();
    ...
    public MRS2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.MRS);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new MRS2_5GUI(i_mdiFrame);
            }
