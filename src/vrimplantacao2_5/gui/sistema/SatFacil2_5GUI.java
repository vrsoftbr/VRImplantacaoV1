...
public class SatFacil2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.SATFACIL.getNome();
    private static SatFacil2_5GUI instance;
    ...
    public SatFacil2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.SATFACIL);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new SatFacil2_5GUI(i_mdiFrame);
            }
