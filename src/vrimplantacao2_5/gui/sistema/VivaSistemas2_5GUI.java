...
public class VivaSistemas2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.VIVASISTEMAS.getNome();
    private static VivaSistemas2_5GUI instance;

    private final VivaSistemasDAO dao = new VivaSistemasDAO();
    ...
    public VivaSistemas2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.VIVASISTEMAS);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new VivaSistemas2_5GUI(i_mdiFrame);
            }
