...
public class STI32_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.STI3.getNome();
    private static STI32_5GUI instance;

    private final STI32_5DAO dao = new STI32_5DAO();
    ...
    public STI32_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.STI3);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new STI32_5GUI(i_mdiFrame);
            }
