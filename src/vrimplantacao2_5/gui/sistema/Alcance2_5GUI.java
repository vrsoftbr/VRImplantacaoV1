...
import vrimplantacao2_5.dao.sistema.AlcanceDAO;
import vrimplantacao2_5.vo.enums.ESistema;

public class Alcance2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.ALCANCE.getNome();
    private static Alcance2_5GUI instance;
    ...
    public Alcance2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.ALCANCE);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Alcance2_5GUI(i_mdiFrame);
            }
