...
public class Acom2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.ACOM.getNome();
    private static Acom2_5GUI instance;

    private final Acom2_5DAO dao = new Acom2_5DAO();
    ...
    public Acom2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.ACOM);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Acom2_5GUI(i_mdiFrame);
            }
