...
public class AutoAdm2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.AUTOADM.getNome();
    private static AutoAdm2_5GUI instance;
    ...
    public AutoAdm2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new AutoAdm2_5GUI(i_mdiFrame);
            }
