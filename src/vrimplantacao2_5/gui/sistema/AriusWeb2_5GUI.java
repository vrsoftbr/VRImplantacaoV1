...
public class AriusWeb2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.ARIUSWEB.getNome();
    private static AriusWeb2_5GUI instance;

    private final AriusWebDAO dao = new AriusWebDAO();
    ...
    public AriusWeb2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.ARIUSWEB);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new AriusWeb2_5GUI(i_mdiFrame);
            }
