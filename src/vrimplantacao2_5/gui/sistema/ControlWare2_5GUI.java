...
public class ControlWare2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.CONTROLWARE.getNome();
    private static ControlWare2_5GUI instance;

    private final ControlWare2_5DAO dao = new ControlWare2_5DAO();
    ...
    public ControlWare2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.CONTROLWARE);
    ...
    public void carregaEspecieReceber() throws Exception {
        ...
        for(ControlWare2_5DAO.PlanoConta esp : dao.getEspecie()) {
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    dao.importarFamiliaDeSimilar = chkFamiliaSimilar.isSelected();
                    dao.tipoPlanoContaReceber = ((ControlWare2_5DAO.PlanoConta) cmbPlanoContas.getSelectedItem()).getId();
                    dao.tipoPlanoContaPagar = ((ControlWare2_5DAO.PlanoConta) cmbContaPagar.getSelectedItem()).getId();
                    ...
                    if (tabProdutos.edtDtVendaFim.getDate() != null) {
                        dao.setDataFimVenda(tabProdutos.edtDtVendaFim.getDate());
                    }
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new ControlWare2_5GUI(i_mdiFrame);
            }
    ...
    private void initComponents() {
        ...
        pnlParametroSistema = new javax.swing.JPanel();
        ...
        lblPlanoContas1 = new vrframework.bean.label.VRLabel();
        ...
        lblPlanoContas.setText("Plano de Contas - Rotativo");

        lblPlanoContas1.setText("Plano de Contas - Contas a Pagar");
        ...
        javax.swing.GroupLayout pnlParametroSistemaLayout = new javax.swing.GroupLayout(pnlParametroSistema);
        pnlParametroSistema.setLayout(pnlParametroSistemaLayout);
        pnlParametroSistemaLayout.setHorizontalGroup(
            pnlParametroSistemaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pnlParametroSistemaLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(pnlParametroSistemaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lblPlanoContas1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(330, Short.MAX_VALUE))
        );
        pnlParametroSistemaLayout.setVerticalGroup(
            pnlParametroSistemaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pnlParametroSistemaLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblPlanoContas, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        tabMenu.addTab("Parametro Sistema", pnlParametroSistema);
    ...
    private vrframework.bean.label.VRLabel lblPlanoContas1;
    ...
    private javax.swing.JPanel pnlParametroSistema;
