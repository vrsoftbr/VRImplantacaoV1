 ...
 */
public class ProSuper2_5GUI extends VRInternalFrame {

    private vrimplantacao2_5.gui.componente.conexao.configuracao.BaseDeDadosPanel pnlConn;
    private static final String SISTEMA = ESistema.PROSUPER.getNome();
    private static ProSuper2_5GUI instance;

    private final ProSuper2_5DAO dao = new ProSuper2_5DAO();
     ...
     */
    public ProSuper2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents2();
        ...
        pnlConn.setSistema(ESistema.PROSUPER);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new ProSuper2_5GUI(i_mdiFrame);
            }
    ...
    private void initComponents() {
        ...
        tabImportacao.addTab(org.openide.util.NbBundle.getMessage(ProSuper2_5GUI.class, "ProSuper2_5GUI.tabFornecedores.TabConstraints.tabTitle"), tabFornecedores); // NOI18N
        ...
        tabImportacao.addTab(org.openide.util.NbBundle.getMessage(ProSuper2_5GUI.class, "ProSuper2_5GUI.tabCli.TabConstraints.tabTitle"), tabCli); // NOI18N
        ...
        tabImportacao.addTab(org.openide.util.NbBundle.getMessage(ProSuper2_5GUI.class, "ProSuper2_5GUI.tabParametro.TabConstraints.tabTitle"), tabParametro); // NOI18N
        tabImportacao.addTab(org.openide.util.NbBundle.getMessage(ProSuper2_5GUI.class, "ProSuper2_5GUI.tabProdutos.TabConstraints.tabTitle"), tabProdutos); // NOI18N

        tabMenu.addTab(org.openide.util.NbBundle.getMessage(ProSuper2_5GUI.class, "ProSuper2_5GUI.tabImportacao.TabConstraints.tabTitle"), tabImportacao); // NOI18N
        tabMenu.addTab(org.openide.util.NbBundle.getMessage(ProSuper2_5GUI.class, "ProSuper2_5GUI.pnlBalanca.TabConstraints.tabTitle"), pnlBalanca); // NOI18N

        btnMigrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vrframework/img/importar.png"))); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(btnMigrar, org.openide.util.NbBundle.getMessage(ProSuper2_5GUI.class, "ProSuper2_5GUI.btnMigrar.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jBLimpar, org.openide.util.NbBundle.getMessage(ProSuper2_5GUI.class, "ProSuper2_5GUI.jBLimpar.text")); // NOI18N
        jBLimpar.setToolTipText(org.openide.util.NbBundle.getMessage(ProSuper2_5GUI.class, "ProSuper2_5GUI.jBLimpar.toolTipText")); // NOI18N
