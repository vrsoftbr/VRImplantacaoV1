...
public class VisualMix2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.VISUALMIX.getNome();
    private static VisualMix2_5GUI instance;

    private final VisualMixDAO dao = new VisualMixDAO();
    ...
    public VisualMix2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.VISUALMIX);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new VisualMix2_5GUI(i_mdiFrame);
            }
