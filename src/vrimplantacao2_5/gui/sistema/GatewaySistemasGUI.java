...
public class GatewaySistemasGUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.GATEWAYSISTEMAS.getNome();
    private static GatewaySistemasGUI instance;

    private final GatewaySistemasDAO2_5 dao = new GatewaySistemasDAO2_5();
    ...
    public GatewaySistemasGUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new GatewaySistemasGUI(i_mdiFrame);
            }
