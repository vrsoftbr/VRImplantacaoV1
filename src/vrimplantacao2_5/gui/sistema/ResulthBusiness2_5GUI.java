...
public class ResulthBusiness2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.RESULTHBUSINESS.getNome();
    private static ResulthBusiness2_5GUI instance;

    private final ResulthBusinessDAO dao = new ResulthBusinessDAO();
    ...
    public ResulthBusiness2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.RESULTHBUSINESS);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new ResulthBusiness2_5GUI(i_mdiFrame);
            }
