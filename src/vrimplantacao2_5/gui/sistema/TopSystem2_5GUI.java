...
public class TopSystem2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.TOPSYSTEM.getNome();
    private static TopSystem2_5GUI instance;

    private final TopSystemDAO dao = new TopSystemDAO();
    ...
    public TopSystem2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.TOPSYSTEM);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new TopSystem2_5GUI(i_mdiFrame);
            }
    ...
    private void btnMigrarActionPerformed(java.awt.event.ActionEvent evt) {                                          
        try {
            this.setWaitCursor();
            gravarParametros();
            importarTabelas();
