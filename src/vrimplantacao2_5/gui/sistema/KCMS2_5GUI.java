...
public class KCMS2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.KCMS.getNome();
    private static KCMS2_5GUI instance;

    private final KcmsDAO dao = new KcmsDAO();
    ...
    public KCMS2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.KCMS);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new KCMS2_5GUI(i_mdiFrame);
            }
