...
public class GZSistemas2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.GZSISTEMAS.getNome();
    private static GZSistemas2_5GUI instance;

    private final GZSistemas2_5DAO dao = new GZSistemas2_5DAO();
    ...
    public GZSistemas2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.GZSISTEMAS);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new GZSistemas2_5GUI(i_mdiFrame);
            }
