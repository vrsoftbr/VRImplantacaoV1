...
public class Provenco_Tentaculo2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.TENTACULO.getNome();
    private static Provenco_Tentaculo2_5GUI instance;
    ...
    public Provenco_Tentaculo2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.TENTACULO);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Provenco_Tentaculo2_5GUI(i_mdiFrame);
            }
