...
public class Arauto2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.ARAUTO.getNome();
    private static Arauto2_5GUI instance;

    private final ArautoDAO dao = new ArautoDAO();
    ...
    public Arauto2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.ARAUTO);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Arauto2_5GUI(i_mdiFrame);
            }
