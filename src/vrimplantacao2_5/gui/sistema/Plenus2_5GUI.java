...
public class Plenus2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.PLENUS.getNome();
    private static Plenus2_5GUI instance;
    ...
    public Plenus2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.PLENUS);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Plenus2_5GUI(i_mdiFrame);
            }
