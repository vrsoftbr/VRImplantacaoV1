...
public class Director2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.DIRECTOR.getNome();
    private static Director2_5GUI instance;

    private final Director2_5DAO dao = new Director2_5DAO();
    ...
    public Director2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.DIRECTOR);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Director2_5GUI(i_mdiFrame);
            }
