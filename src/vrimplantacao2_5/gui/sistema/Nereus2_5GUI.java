...
public class Nereus2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.NEREUS.getNome();
    private static Nereus2_5GUI instance;

    private final NereusDAO dao = new NereusDAO();
    ...
    public Nereus2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.NEREUS);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Nereus2_5GUI(i_mdiFrame);
            }
