...
import vrimplantacao2_5.dao.sistema.Asefe2_5DAO;
...
public class Asefe2_5GUI extends VRInternalFrame {
    ...
    private final Asefe2_5DAO dao = new Asefe2_5DAO();
    ...
    public Asefe2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.ASEFE);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Asefe2_5GUI(i_mdiFrame);
            }
