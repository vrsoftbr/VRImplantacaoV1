...
public class Facil2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.FACIL.getNome();
    private static Facil2_5GUI instance;

    private final FacilDAO dao = new FacilDAO();
    ...
    public Facil2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.FACIL);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Facil2_5GUI(i_mdiFrame);
            }
