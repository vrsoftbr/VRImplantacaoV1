...
public class Avance2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.AVANCE.getNome();
    private static Avance2_5GUI instance;

    private final AvanceDAO dao = new AvanceDAO();
    ...
    public Avance2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.AVANCE);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Avance2_5GUI(i_mdiFrame);
            }
