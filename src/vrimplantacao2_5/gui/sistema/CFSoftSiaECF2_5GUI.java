...
public class CFSoftSiaECF2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.CFSOFTSIAECF.getNome();
    private static CFSoftSiaECF2_5GUI instance;

    private final CFSoftSiaECF2_5DAO dao = new CFSoftSiaECF2_5DAO();
    ...
    public CFSoftSiaECF2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.CFSOFTSIAECF);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new CFSoftSiaECF2_5GUI(i_mdiFrame);
            }
