...
public class Scorpion2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.SCORPION.getNome();
    private static Scorpion2_5GUI instance;

    private final ScorpionDAO dao = new ScorpionDAO();
    ...
    public Scorpion2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.SCORPION);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Scorpion2_5GUI(i_mdiFrame);
            }
