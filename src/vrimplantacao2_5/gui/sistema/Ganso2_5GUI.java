...
public class Ganso2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.GANSO.getNome();
    private static Ganso2_5GUI instance;

    private final GansoDAO dao = new GansoDAO();
    ...
    public Ganso2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.GANSO);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Ganso2_5GUI(i_mdiFrame);
            }
