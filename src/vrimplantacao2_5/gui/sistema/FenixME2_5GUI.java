...
public class FenixME2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.FENIXME.getNome();
    private static FenixME2_5GUI instance;

    private final FenixMEDAO dao = new FenixMEDAO();
    ...
    public FenixME2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.FENIXME);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new FenixME2_5GUI(i_mdiFrame);
            }
