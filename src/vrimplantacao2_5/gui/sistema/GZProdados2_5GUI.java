...
public class GZProdados2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.GZPRODADOS.getNome();
    private static GZProdados2_5GUI instance;
    private String vLojaCliente = "-1";
    private int vLojaVR = -1;
    private final GZProdadosDAO dao = new GZProdadosDAO();
    ...
    public GZProdados2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new GZProdados2_5GUI(i_mdiFrame);
            }
