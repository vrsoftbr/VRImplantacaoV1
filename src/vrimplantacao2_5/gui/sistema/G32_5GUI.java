...
public class G32_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.G3.getNome();
    private static G32_5GUI instance;

    private final G3DAO2_5 dao = new G3DAO2_5();
    ...
    public G32_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.G3);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new G32_5GUI(i_mdiFrame);
            }
