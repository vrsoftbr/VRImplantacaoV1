...
public class Stock_Postgres2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.STOCK.getNome();
    private static Stock_Postgres2_5GUI instance;

    private final Stock_PostgresDAO dao = new Stock_PostgresDAO();
    ...
    public Stock_Postgres2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.STOCK);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Stock_Postgres2_5GUI(i_mdiFrame);
            }
