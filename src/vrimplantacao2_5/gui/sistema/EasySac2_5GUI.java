...
import vrimplantacao2_5.dao.sistema.EasySac2_5DAO;


public class EasySac2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.EASYSAC.getNome();
    private static EasySac2_5GUI instance;

    private final EasySac2_5DAO dao = new EasySac2_5DAO();
    ...
    public EasySac2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.EASYSAC);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new EasySac2_5GUI(i_mdiFrame);
            }
