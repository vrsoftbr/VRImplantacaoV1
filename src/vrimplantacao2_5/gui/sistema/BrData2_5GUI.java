...
public class BrData2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.BRDATA.getNome();
    private static BrData2_5GUI instance;

    private final BrDataDAO dao = new BrDataDAO();
    ...
    public BrData2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        ...
        pnlConn.setSistema(ESistema.BRDATA);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new BrData2_5GUI(i_mdiFrame);
            }
    ...
    private void initComponents() {
        ...
        getAccessibleContext().setAccessibleName("BRDATA");
