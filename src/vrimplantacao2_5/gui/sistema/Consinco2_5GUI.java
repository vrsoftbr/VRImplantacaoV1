...
public class Consinco2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.CONSINCO.getNome();
    private static Consinco2_5GUI instance;

    private final ConsincoDAO consincoDAO = new ConsincoDAO();
    ...
    public Consinco2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        carregarParametros();
        tabProdutos.setOpcoesDisponiveis(consincoDAO);
        tabFornecedores.setOpcoesDisponiveis(consincoDAO);
        tabClientes.setOpcoesDisponiveis(consincoDAO);
        ...
        tabProdutos.setProvider(new MapaTributacaoButtonProvider() {
            ...
            public String getLoja() {
                consincoDAO.setLojaOrigem(pnlConn.getLojaOrigem());
                return consincoDAO.getLojaOrigem();
            }
        ...
        pnlConn.setSistema(ESistema.CONSINCO);
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    Importador importador = new Importador(consincoDAO);
                        ...
                        switch (tabImportacao.getSelectedIndex()) {
                            ...
                            case 3:
                                if(chkPdvVendas.isSelected()) {
                                    consincoDAO.setDataInicioVenda(edtDtVendaIni.getDate());
                                    consincoDAO.setDataTerminoVenda(edtDtVendaFim.getDate());
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Consinco2_5GUI(i_mdiFrame);
            }
    ...
    private void initComponents() {
        ...
        jBLimpar4.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        jBLimpar4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vrframework/img/apagar.png"))); // NOI18N
        jBLimpar4.setText("Limpar");
        jBLimpar4.setToolTipText("Limpa todos os itens selecionados");
        ...
        pnlMigrarLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlMigrarLayout.createSequentialGroup()
                ...
                .addComponent(jBLimpar4, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
