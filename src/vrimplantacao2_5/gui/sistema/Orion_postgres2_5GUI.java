...
public class Orion_postgres2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.ORION_POSTGRES.getNome();
    private static Orion_postgres2_5GUI instance;

    private final Orion_PostgresDAO dao = new Orion_PostgresDAO();
    ...
    public Orion_postgres2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.ORION_POSTGRES);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Orion_postgres2_5GUI(i_mdiFrame);
            }
