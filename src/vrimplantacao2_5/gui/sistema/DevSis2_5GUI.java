...
public class DevSis2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.DEVSIS.getNome();
    private static DevSis2_5GUI instance;

    private final DevSisDAO dao = new DevSisDAO();
    ...
    public DevSis2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new DevSis2_5GUI(i_mdiFrame);
            }
