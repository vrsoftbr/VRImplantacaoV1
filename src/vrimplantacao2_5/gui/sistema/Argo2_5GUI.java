...
public class Argo2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.ARGO.getNome();
    private static Argo2_5GUI instance;

    private final ArgoDAO dao = new ArgoDAO();
    ...
    public Argo2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.ARGO);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Argo2_5GUI(i_mdiFrame);
            }
