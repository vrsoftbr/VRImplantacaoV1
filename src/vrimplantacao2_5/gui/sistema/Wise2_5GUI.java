...
public class Wise2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.WISE.getNome();
    private static Wise2_5GUI instance;

    private final WiseDAO dao = new WiseDAO();
    ...
    public Wise2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.WISE);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Wise2_5GUI(i_mdiFrame);
            }
