...
public class LCSistemas2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.LCSISTEMAS.getNome();
    private static LCSistemas2_5GUI instance;

    private final LCSistemasDAO dao = new LCSistemasDAO();
    ...
    public LCSistemas2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new LCSistemas2_5GUI(i_mdiFrame);
            }
