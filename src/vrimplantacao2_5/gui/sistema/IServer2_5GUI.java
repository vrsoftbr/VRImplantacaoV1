...
public class IServer2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.ISERVER.getNome();
    private static IServer2_5GUI instance;

    private final IServerDAO dao = new IServerDAO();
    ...
    public IServer2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.ISERVER);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new IServer2_5GUI(i_mdiFrame);
            }
