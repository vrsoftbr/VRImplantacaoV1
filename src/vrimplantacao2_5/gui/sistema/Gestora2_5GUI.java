...
public class Gestora2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.GESTORA.getNome();
    private static Gestora2_5GUI instance;

    private final GestoraDAO dao = new GestoraDAO();
    ...
    public Gestora2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.GESTORA);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Gestora2_5GUI(i_mdiFrame);
            }
