...
public class BrajanGestores2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.BRAJANGESTORES.getNome();
    private static BrajanGestores2_5GUI instance;

    private final BrajanGestores2_5DAO dao = new BrajanGestores2_5DAO();
    ...
    public BrajanGestores2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.BRAJANGESTORES);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new BrajanGestores2_5GUI(i_mdiFrame);
            }
