...
public class Manager2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.MANAGER.getNome();
    private static Manager2_5GUI instance;
    ...
    public Manager2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.MANAGER);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Manager2_5GUI(i_mdiFrame);
            }
    ...
    private void initComponents() {
        ...
        chkSegundoEan = new vrframework.bean.checkBox.VRCheckBox();
        try {
        ...
        chkGerarCodigoAtacado.setText("Gerar Código de Atacado");

        chkRemoveDigitoBalanca.setText("Remove Digíto do EAN para Produto de Balança");

        chkSegundoEan.setText("Carregar seugundo EAN");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(vRImportaArquivBalancaPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 589, Short.MAX_VALUE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(6, 6, 6)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(chkSegundoEan, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        tabMenu.addTab("Especifico", jPanel1);
    ...
    private vrframework.bean.checkBox.VRCheckBox chkSegundoEan;
