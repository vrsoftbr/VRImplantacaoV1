...
public class WLS2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.WLS.getNome();
    private static WLS2_5GUI instance;

    private final WLSDAO dao = new WLSDAO();
    ...
    public WLS2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.WLS);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new WLS2_5GUI(i_mdiFrame);
            }
