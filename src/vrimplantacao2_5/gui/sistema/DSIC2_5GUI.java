...
public class DSIC2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.DSIC.getNome();
    private static DSIC2_5GUI instance;

    private final DSICDAO dao = new DSICDAO();
    ...
    public DSIC2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new DSIC2_5GUI(i_mdiFrame);
            }
