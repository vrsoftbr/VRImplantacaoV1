...
public class Jmaster2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.JMASTER.getNome();
    private static Jmaster2_5GUI instance;

    private final Jmaster2_5DAO dao = new Jmaster2_5DAO();
    ...
    public Jmaster2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.JMASTER);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Jmaster2_5GUI(i_mdiFrame);
            }
    ...
    private void initComponents() {
        ...
        chkPdvVendasCustos.setText("Atualizar custos da vendas");
