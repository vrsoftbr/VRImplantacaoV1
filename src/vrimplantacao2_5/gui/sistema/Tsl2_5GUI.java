...
import vrimplantacao2_5.controller.sistema.TslController;
import vrimplantacao2_5.gui.componente.conexao.ConexaoEvent;
import vrimplantacao2_5.vo.enums.ESistema;
import vrimplantacao2_5.vo.sistema.TslVO;

public class Tsl2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.TSL.getNome();
    private static Tsl2_5GUI instance;
    private String vLojaCliente = "-1";
    private int vLojaVR = -1;
    private TslVO vo = new TslVO();
    private TslController controller = null;
    ...
    private TslVO carregarOpcaoesMigracaoSistema() throws Exception {
    ...
    public Tsl2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.TSL);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Tsl2_5GUI(i_mdiFrame);
            }
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    controller.setTsl(carregarOpcaoesMigracaoSistema());
