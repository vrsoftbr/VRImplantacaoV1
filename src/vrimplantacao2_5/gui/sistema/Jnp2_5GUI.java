...
import vrimplantacao2_5.controller.sistema.JNPController;
import vrimplantacao2_5.gui.componente.conexao.ConexaoEvent;
import vrimplantacao2_5.vo.enums.ESistema;
import vrimplantacao2_5.vo.sistema.JnpVO;

public class Jnp2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.JNP.getNome();
    private static Jnp2_5GUI instance;
    private String vLojaCliente = "-1";
    private int vLojaVR = -1;
    private JnpVO vo = new JnpVO();
    private JNPController controller = null;
    ...
    private JnpVO carregarOpcaoesMigracaoSistema() throws Exception {
    ...
    public Jnp2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.JNP);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Jnp2_5GUI(i_mdiFrame);
            }
    ...
    private void initComponents() {
        ...
        vRPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(vRPanel7Layout.createSequentialGroup()
                .addComponent(tabProdutos, javax.swing.GroupLayout.DEFAULT_SIZE, 985, Short.MAX_VALUE)
                .addContainerGap())
        );
        vRPanel7Layout.setVerticalGroup(
            vRPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(tabProdutos, javax.swing.GroupLayout.DEFAULT_SIZE, 526, Short.MAX_VALUE)
        );
