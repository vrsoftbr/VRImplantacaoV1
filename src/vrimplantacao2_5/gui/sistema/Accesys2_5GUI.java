...
public class Accesys2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.ACCESYS.getNome();
    private static Accesys2_5GUI instance;

    private final Accesys2_5DAO dao = new Accesys2_5DAO();
    ...
    public Accesys2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.ACCESYS);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Accesys2_5GUI(i_mdiFrame);
            }
