...
public class Dx2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.DX.getNome();
    private static Dx2_5GUI instance;

    private final DxDAO dao = new DxDAO();
    ...
    public Dx2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.DX);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Dx2_5GUI(i_mdiFrame);
            }
