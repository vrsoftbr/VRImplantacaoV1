...
import vrimplantacao2_5.controller.sistema.FXSistemasController;
...
public class FXSistemas2_5GUIPadrao extends VRInternalFrame {

    private static final String SISTEMA = ESistema.FXSISTEMAS.getNome();
    private static FXSistemas2_5GUIPadrao instance;
    private String vLojaCliente = "-1";
    private int vLojaVR = -1;
    private FXSistemasDAOPadrao dao = null;
    private FXSistemasVO vo = new FXSistemasVO();
    private FXSistemasController controller = null;
    ...
    private void carregarParametros() throws Exception {
        ...
        chkProdProdutoBalancaIniciaCom789.setSelected(params.getBool(SISTEMA, "PRODUTO DE BALANCA INICIA COM 789"));
    }
    ...
    private void gravarParametros() throws Exception {
        ...
        params.put(chkProdProdutoBalancaIniciaCom789.isSelected(), SISTEMA, "PRODUTO DE BALANCA INICIA COM 789");
    ...
    public FXSistemas2_5GUIPadrao(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        controller = new FXSistemasController();
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new FXSistemas2_5GUIPadrao(i_mdiFrame);
            }
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    controller.dao.setComplementoSistema(pnlConn.getComplemento());
                    controller.setFXSistemas(carregarOpcaoesMigracaoSistema());
    ...
    private void initComponents() {
        ...
        chkProdProdutoBalancaIniciaCom789 = new vr.view.components.checkbox.VRCheckBox();
        ...
        chkProdProdutoBalancaIniciaCom789.setText("Produtos de Balança iniciam com \"789\"");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(chkProdProdutoBalancaIniciaCom789, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        tabs.addTab("Parâmetros FxSistemas", tabParametros);
        ...
        vRPanel7Layout.setVerticalGroup(
            vRPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(tabProdutos, javax.swing.GroupLayout.DEFAULT_SIZE, 589, Short.MAX_VALUE)
        );
        ...
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addComponent(vRImportaArquivBalancaPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 333, Short.MAX_VALUE)
                .addGap(304, 304, 304))
        );
    ...
    private vr.view.components.checkbox.VRCheckBox chkProdProdutoBalancaIniciaCom789;
