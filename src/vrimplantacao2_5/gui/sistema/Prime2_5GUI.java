...
public class Prime2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.PRIME.getNome();
    private static Prime2_5GUI instance;

    private final PrimeDAO dao = new PrimeDAO();
    ...
    public Prime2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.PRIME);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Prime2_5GUI(i_mdiFrame);
            }
