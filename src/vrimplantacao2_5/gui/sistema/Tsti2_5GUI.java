...
public class Tsti2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.TSTI.getNome();
    private static Tsti2_5GUI instance;

    private final TstiDAO2_5 dao = new TstiDAO2_5();
    ...
    public Tsti2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.TSTI);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Tsti2_5GUI(i_mdiFrame);
            }
