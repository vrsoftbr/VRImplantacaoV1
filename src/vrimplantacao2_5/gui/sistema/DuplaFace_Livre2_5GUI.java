...
public class DuplaFace_Livre2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.LIVRE.getNome();
    private static DuplaFace_Livre2_5GUI instance;

    private final DuplaFace_LivreDAO dao = new DuplaFace_LivreDAO();
    ...
    public DuplaFace_Livre2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.LIVRE);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new DuplaFace_Livre2_5GUI(i_mdiFrame);
            }
