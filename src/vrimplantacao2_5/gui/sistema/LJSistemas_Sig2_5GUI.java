...
public class LJSistemas_Sig2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.LJSISTEMAS_SIG.getNome();
    private static LJSistemas_Sig2_5GUI instance;

    private final LJSistemas_SigDAO dao = new LJSistemas_SigDAO();
    ...
    public LJSistemas_Sig2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.LJSISTEMAS_SIG);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new LJSistemas_Sig2_5GUI(i_mdiFrame);
            }
