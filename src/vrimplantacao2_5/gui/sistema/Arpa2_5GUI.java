...
public class Arpa2_5GUI extends VRInternalFrame {
    
    private Connection loja;
    private Connection venda;

    private static final String SISTEMA = ESistema.ARPA.getNome();
    private static Arpa2_5GUI instance;

    private final Arpa_PostgresDAO dao = new Arpa_PostgresDAO();
    ...
    public Arpa2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.ARPA);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Arpa2_5GUI(i_mdiFrame);
            }
