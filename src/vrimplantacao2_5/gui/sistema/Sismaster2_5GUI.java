...
import vrimplantacao2_5.dao.sistema.SismasterDAO;
import vrimplantacao2_5.vo.enums.ESistema;

public class Sismaster2_5GUI extends VRInternalFrame {

    private static final String SISTEMA = ESistema.SISMASTER.getNome();
    private static Sismaster2_5GUI instance;

    private final SismasterDAO dao = new SismasterDAO();
    ...
    public Sismaster2_5GUI(VRMdiFrame i_mdiFrame) throws Exception {
        super(i_mdiFrame);
        initComponents();
        ...
        pnlConn.setSistema(ESistema.SISMASTER);
    ...
    public static void exibir(VRMdiFrame i_mdiFrame) {
        try {
            ...
            if (instance == null || instance.isClosed()) {
                instance = new Sismaster2_5GUI(i_mdiFrame);
            }
