package vrimplantacao2_5.gui.componente.conexao.db2;
 ...
 * @author Wesley
 */
public class ConexaoDB2Panel extends javax.swing.JPanel implements ConfiguracaoPanel {

    private String sistema;
    private ConexaoDB2 conexao = new ConexaoDB2();
     ...
     */
    public ConexaoDB2Panel() {
        initComponents();
    }
    
    public ConexaoDB2Panel(String schema, 
            int porta, 
            String usuario, 
            String senha) {
    ...
    private void initComponents() {
        ...
        txtStrConexao.setText("jdbc:db2://10.0.2.250:50000/nome_banco");
        ...
        getAccessibleContext().setAccessibleName("Conexão DB2");
    ...
    public void validarDadosAcesso() throws Exception {
        if (txtHost.getText().isEmpty()) {
            throw new VRException("Favor informar host do banco de dados DB2!");
        }
        if (txtPorta.getText().isEmpty()) {
            throw new VRException("Favor informar a porta do banco de dados DB2!");
        }
        if (txtDatabase.getArquivo().isEmpty()) {
            throw new VRException("Favor informar nome do banco de dados DB2!");
        }
        if (txtUsuario.getText().isEmpty()) {
            throw new VRException("Favor informar o usuário do banco de dados DB2!");
        }
    ...
    public void carregarParametros() {
        ...
        txtHost.setText(params.getWithNull(host, sistema, "DB2", "HOST"));
        txtDatabase.setArquivo(params.getWithNull(database, sistema, "DB2", "DATABASE"));
        txtPorta.setText(params.getWithNull(port, sistema, "DB2", "PORTA"));
        txtUsuario.setText(params.getWithNull(user, sistema, "DB2", "USUARIO"));
        txtSenha.setText(params.getWithNull(pass, sistema, "DB2", "SENHA"));
    }
    
    public String pass = "db2";
    public String user = "db2";
    ...
    public void atualizarParametros() {
        Parametros params = Parametros.get();
        params.put(txtHost.getText(), sistema, "DB2", "HOST");
        params.put(txtDatabase.getArquivo(), sistema, "DB2", "DATABASE");
        params.put(txtPorta.getText(), sistema, "DB2", "PORTA");
        params.put(txtUsuario.getText(), sistema, "DB2", "USUARIO");
        params.put(txtSenha.getText(), sistema, "DB2", "SENHA");
    }
