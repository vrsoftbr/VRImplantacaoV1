 ...
 * @author Michael
 */
public class Jnp_MSuperController extends InterfaceController {

    public Jnp_MSuperDAO dao = null;

    public Jnp_MSuperController() {
        this.dao = new Jnp_MSuperDAO();
    }

    public Jnp_MSuperController(Jnp_MSuperDAO dao) {
        this.dao = dao;
    }

    public void setJnp(Jnp_MSuperVO jnpVO) {
        dao.jnpVO = jnpVO;
    }
