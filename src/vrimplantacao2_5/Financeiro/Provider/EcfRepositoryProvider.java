...
import vrimplantacao2_5.Financeiro.DAO.EcfDAO;
import vrimplantacao2_5.Financeiro.VO.EcfVO;

public class EcfRepositoryProvider {

    private final EcfDAO ecf = new EcfDAO();

    private final String sistema;
    private final String loja;
    private final int lojaVR;

    public EcfRepositoryProvider(String sistema, String loja, int lojaVR) {
    ...
    public void gravar(EcfVO vo) throws Exception {
        ecf.salvar(vo);
