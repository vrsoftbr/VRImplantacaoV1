...
import vrimplantacao2_5.Financeiro.DAO.PdvFuncaoDAO;
import vrimplantacao2_5.Financeiro.VO.PdvFuncaoVO;

public class PdvFuncaoRepositoryProvider {

    private final PdvFuncaoDAO funcao = new PdvFuncaoDAO();

    private final String sistema;
    private final String loja;
    private final int lojaVR;

    public PdvFuncaoRepositoryProvider(String sistema, String loja, int lojaVR) {
    ...
    public void gravar(PdvFuncaoVO vo) throws Exception {
        funcao.salvar(vo);
