...
import vrimplantacao2_5.Financeiro.DAO.TipoModeloDAO;
import vrimplantacao2_5.Financeiro.VO.TipoModeloVO;

public class TipoModeloRepositoryProvider {

    private final TipoModeloDAO modelo = new TipoModeloDAO();

    private final String sistema;
    private final String loja;
    private final int lojaVR;

    public TipoModeloRepositoryProvider(String sistema, String loja, int lojaVR) {
    ...
    public void gravar(TipoModeloVO vo) throws Exception {
        modelo.salvar(vo);
