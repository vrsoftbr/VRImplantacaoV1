...
import vrimplantacao2_5.Financeiro.DAO.EcfLayoutDAO;
import vrimplantacao2_5.Financeiro.VO.EcfLayoutVO;

public class EcfLayoutRepositoryProvider {

    private final EcfLayoutDAO ecf = new EcfLayoutDAO();

    private final String sistema;
    private final String loja;
    private final int lojaVR;

    public EcfLayoutRepositoryProvider(String sistema, String loja, int lojaVR) {
    ...
    public void gravar(EcfLayoutVO vo) throws Exception {
        ecf.salvar(vo);
