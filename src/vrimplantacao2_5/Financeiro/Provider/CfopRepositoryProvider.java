...
import vrimplantacao2_5.Financeiro.DAO.CfopDAO;
import vrimplantacao2_5.Financeiro.VO.CfopVO;

public class CfopRepositoryProvider {

    private final CfopDAO cfop = new CfopDAO();

    private final String sistema;
    private final String loja;
    private final int lojaVR;

    public CfopRepositoryProvider(String sistema, String loja, int lojaVR) {
    ...
    public void gravar(CfopVO vo) throws Exception {
        cfop.salvar(vo);
