 ...
 * @author Bruno
 */
public class FinalizadoraConfiguracaoIMP {
    ...
    private boolean aceitaRetiradad;
     ...
     */
    public boolean isAceitaRetiradad() {
        return aceitaRetiradad;
    }

    /**
     * @param aceitaRetiradad the aceitaRetiradad to set
     */
    public void setAceitaRetiradad(boolean aceitaRetiradad) {
        this.aceitaRetiradad = aceitaRetiradad;
    }
