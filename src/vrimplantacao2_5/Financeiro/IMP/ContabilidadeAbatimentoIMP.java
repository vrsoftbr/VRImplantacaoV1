 ...
 * @author Bruno
 */
public class ContabilidadeAbatimentoIMP {

    private String importSistema;
    private String importLoja;

    private Integer id;
    private Integer id_tipoAbatimento;
    ...
    /**
     * @return the id_tipoAbatimento
     */
    public Integer getId_tipoAbatimento() {
        return id_tipoAbatimento;
    }

    /**
     * @param id_tipoAbatimento the id_tipoAbatimento to set
     */
    public void setId_tipoAbatimento(Integer id_tipoAbatimento) {
        this.id_tipoAbatimento = id_tipoAbatimento;
    }
