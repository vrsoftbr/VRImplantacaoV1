 ...
 * @author Bruno
 */
public class ContabilidadeTipoSaidaDAO {

    private int idLojaVR = 1;
    private String importSistema = null;
    private String importLoja = null;

    private static Logger LOG = Logger.getLogger(ContabilidadeTipoSaidaDAO.class.getName());
    

    public void salvar(ContabilidadeTipoSaidaVO vo) throws Exception {
