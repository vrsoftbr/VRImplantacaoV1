...
public class TipoSaidaDAO {
    ...
    public void salvar(TipoSaidaVO vo) throws Exception {
        try (Statement stm = Conexao.createStatement()) {
            ...
            sql.put("id_notasaidamensagem", vo.getId_notaSaidaMensagem() == 0 ? null : vo.getId_notaSaidaMensagem());
            ...
            sql.put("id_tiposaida", vo.getId_tipoSaida() == 0 ? null : vo.getId_tipoSaida());
