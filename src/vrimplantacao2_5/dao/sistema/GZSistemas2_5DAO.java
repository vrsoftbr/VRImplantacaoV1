 ...
 * @author lucasrafael
 */
public class GZSistemas2_5DAO extends InterfaceDAO implements MapaTributoProvider {

    private static final Logger LOG = Logger.getLogger(GZSistemas2_5DAO.class.getName());
    ...
    private static class VendaIterator implements Iterator<VendaIMP> {
        ...
        public VendaIterator(String idLojaCliente, Date dataInicio, Date dataTermino) throws Exception {
            this.sql
                    ...
                    + "vd.operador, vd.cliente, vd.cgc, cli.cgc,\n"
                    + "cli.razsoc, cli.ender, cli.numero, cli.complemen,\n"
                    + "cli.bairro, cli.munic, cli.estado, cli.cep";
