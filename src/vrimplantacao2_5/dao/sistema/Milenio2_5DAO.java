 ...
 * @author Alan
 */
public class Milenio2_5DAO extends InterfaceDAO implements MapaTributoProvider {
    ...
    public List<FamiliaProdutoIMP> getFamiliaProduto() throws Exception {
        ...
        try (Statement st = vrimplantacao.classe.ConexaoSqlServer.getConexao().createStatement()) {
            try (ResultSet rs = st.executeQuery(
                    "select\n" +
                    "	PROCOD id,\n" +
                    "	prodes descricao\n" +
