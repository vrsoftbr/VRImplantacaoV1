 ...
 * @author Michael
 */
public class Jnp_MSuperDAO extends InterfaceDAO implements MapaTributoProvider {

    public boolean utilizarSup025 = false;
    public Jnp_MSuperVO jnpVO = null;
    private final String SISTEMA = "JNP-MSUPER";
    ...
    public Iterator<VendaIMP> getVendaIterator() throws Exception {
        return new Jnp_MSuperDAO.VendaIterator(getLojaOrigem(), this.jnpVO.getDataInicioVenda(), this.jnpVO.getDataTerminoVenda());
    }

    @Override
    public Iterator<VendaItemIMP> getVendaItemIterator() throws Exception {
        return new Jnp_MSuperDAO.VendaItemIterator(getLojaOrigem(), this.jnpVO.getDataInicioVenda(), this.jnpVO.getDataTerminoVenda());
    }
