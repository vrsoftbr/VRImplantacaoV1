...
public class AriusDAO extends InterfaceDAO implements MapaTributoProvider {
    ...
    public Iterator<VendaIMP> getVendaIterator() throws Exception {
        return new AriusDAO.VendaIterator(getLojaOrigem(), this.dataInicioVenda, this.dataTerminoVenda);
    }

    @Override
    public Iterator<VendaItemIMP> getVendaItemIterator() throws Exception {
        return new AriusDAO.VendaItemIterator(getLojaOrigem(), this.dataInicioVenda, this.dataTerminoVenda);
    }
