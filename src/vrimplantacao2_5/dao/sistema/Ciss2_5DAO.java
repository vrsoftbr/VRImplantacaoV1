    ...
    public List<FornecedorIMP> getFornecedores() throws Exception {
        ...
        try (Statement stm = ConexaoDB2.getConexao().createStatement()) {
            try (ResultSet rst = stm.executeQuery(
                    ...
                    + "WHERE (f.TIPOCADASTRO IN ('A','F') OR f.IDCLIFOR IN (10006, 1000036, 1000037))\n"
                    + "ORDER BY f.IDCLIFOR "
            )) {
                while (rst.next()) {
    ...
    public List<ContaReceberIMP> getContasReceber(Set<OpcaoContaReceber> opt) throws Exception {
        ...
        try (Statement stm = ConexaoDB2.getConexao().createStatement()) {
            try (ResultSet rst = stm.executeQuery(
                    ...
                    + "	CASE\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'ALELO ALIMENTACA' THEN 51\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'ALELO ALIMENTACAO' THEN 52\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'ALELO BENEFICIO' THEN 53\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'ALELO MULTIBENEF' THEN 54\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'ALELO REFEICAO' THEN 55\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'AMEX' THEN 56\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'CABAL DEBITO' THEN 57\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'CHIP ALIMENTACAO' THEN 58\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'CREDITO' THEN 59\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'ELO CREDITO' THEN 60\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'ELO DEBITO' THEN 61\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'ELO VISA DEBITO' THEN 62\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'GOODCARD CREDITO' THEN 63\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'GREENCARD ALIMEN' THEN 64\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'IFOOD' THEN 65\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'MAESTRO' THEN 66\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'MASTERCARD' THEN 67\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'MASTERCARD DEBIT' THEN 68\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'MEGAVALE DEBITO' THEN 69\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'OUTROS' THEN 70\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'PIX' THEN 71\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'PIX REDE' THEN 72\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'SMART_NET' THEN 73\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'SODEXO ALIMENTAC' THEN 74\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'SODEXO ALIMENTACAO' THEN 75\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'SODEXO GIFT' THEN 76\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'SODEXO REFEICAO' THEN 77\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'SODEXO REFEIÇÃO' THEN 78\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'SODEXO VOUCHER' THEN 79\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'SOFTNEX' THEN 80\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'TICKET ALIMENTAC' THEN 81\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'TICKET ALIMENTACAO' THEN 82\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'TICKET FLEX' THEN 83\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'TICKET REFEICAO' THEN 84\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'TICKET RESTAURAN' THEN 85\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'TICKET RESTAURANTE' THEN 86\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'TRICARDMAIS CRED' THEN 87\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'VALE CARD' THEN 88\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'VEGASCARD' THEN 89\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'VEGASCARD ALIMENTACAO' THEN 90\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'VEGASCARD CREDITO' THEN 91\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'VEROCARD ALIMENT' THEN 92\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'VISA CREDITO' THEN 93\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'VISA ELECTRON' THEN 94\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'VISA ELECTRON NA' THEN 95\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'VR BENEF' THEN 96\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'VR BENEFICIOS' THEN 97\n"
                    + " WHEN REPLACE(UPPER(ab.DESCRINSTITUICAO), '.', '_') = 'VR REF' THEN 98\n"
                    + "		ELSE 99\n"
                    + "	END tipo_id,\n"
                    + "	' - ' || OBSTITULO AS obs\n"
                    + "FROM\n"
                    ...
                    + "	AND IDCLIFORFIDELIZADO IS NOT NULL\n"
