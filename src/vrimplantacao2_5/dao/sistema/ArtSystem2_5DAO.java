 ...
 * @author lucasrafael
 */
public class ArtSystem2_5DAO extends InterfaceDAO implements MapaTributoProvider {

    private static final Logger LOG = Logger.getLogger(ArtSystem2_5DAO.class.getName());
