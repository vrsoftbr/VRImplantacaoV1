...
// CLASSE REFATORADA DA 2.0 PARA 2.5 E NAO TESTADA!

public class Asefe2_5DAO extends InterfaceDAO implements MapaTributoProvider {

    private static final Logger LOG = Logger.getLogger(Asefe2_5DAO.class.getName());
    ...
    public Iterator<VendaIMP> getVendaIterator() throws Exception {
        return new Asefe2_5DAO.VendaIterator(getLojaOrigem(), dataInicioVenda, dataTerminoVenda);
    }

    @Override
    public Iterator<VendaItemIMP> getVendaItemIterator() throws Exception {
        return new Asefe2_5DAO.VendaItemIterator(getLojaOrigem(), dataInicioVenda, dataTerminoVenda);
    }
