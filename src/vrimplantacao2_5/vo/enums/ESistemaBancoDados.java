...
public enum ESistemaBancoDados {
    ...
    FIREBIRD_SYSAUT(168, "SYSAUT", 5, "FIREBIRD", "", "SYSDBA", "masterkey", 3050),
    ...
    FIREBIRD_PRISMAFLEX(214, "PRISMAFLEX", 5, "FIREBIRD", "", "SYSDBA", "masterkey", 3050),
    FIREBIRD_JNP_MSUPER(219, "JNP-MSUPER", 5, "FIREBIRD", "", "SYSDBA", "masterkey", 3050),
    FIREBIRD_MEGASOFTWARE(224, "MEGA SOFTWARE", 5, "FIREBIRD", "", "SYSDBA", "masterkey", 3050),
    ...
    POSTGRESQL_ORION(227, "ORION_POSTGRES", 11, "POSTGRESQL", "", "postgres", "VrPost@Server", 8745),
    ...
    SQLSERVER_GETWAY(68, "GETWAY", 13, "SQLSERVER", "GWOLAP", "gws", "gws", 1433),
    ...
    SQLSERVER_KCMS(92, "KCMS", 13, "SQLSERVER", "", "", "", 1433),
    SQLSERVER_LINCE(95, "LINCE", 13, "SQLSERVER", "", "", "", 1433),
    ...
    SQLSERVER_SISMOURA(154, "SISMOURA", 13, "SQLSERVER", "", "", "", 1433),
