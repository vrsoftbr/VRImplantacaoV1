...
import vrimplantacao2_5.tipoRecebivel.Provider.EntradaSaidaTipoSaidaRepositoryProvider;
...
public class EntradaSaidaTipoSaidaRepository {
    ...
    public void importarCfopSaida(List<EntradaSaidaTipoSaidaIMP> entradaSaida) throws Exception {
