...
import vr.implantacao.service.conexaofactory.PainelConexaoFactory;
...
public class ConfiguracaoBaseDadosService {
    ...
    public javax.swing.JPanel exibiPainelConexao(int idBancoDados) {
        return PainelConexaoFactory.getPanelConexao(idBancoDados);
    }
}
